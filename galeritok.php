...
$id = $_GET["idgallery"];
  ...
  $querysearch  =" select a.gallery_greatcharacter as foto from greatcharacter_gallery as a left join 
  greatcharacter as b on a.id_greatcharacter=b.id where a.id_greatcharacter='$id'";       
