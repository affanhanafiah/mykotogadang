...
// 				FROM (SELECT a.id_angkot, a.destination, a.track,a.cost,  ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude) As l )) As properties 
// 				FROM angkot As a where a.id_angkot='$id_angkot'
// 				) As f ) As fc
// 			  ";
...
as longitude, ST_Y(ST_Centroid(angkot.geom)) as latitide from angkot where angkot.id_angkot='$id_angkot'" ; 
