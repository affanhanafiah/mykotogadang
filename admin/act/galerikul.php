...
<?php                       require 'connect.php';
                      ...
                      $id = $_GET["idgallery"];
                         ...
                         $querysearch    ="SELECT id_culinary, gallery_culinary from culinary_gallery where id_culinary='$id'";                       

                      $index = 1;
                      $hasil=mysqli_query($conn, $querysearch);
                      while($baris = mysqli_fetch_assoc($hasil))
                      {
                        if((($baris['gallery_culinary']=='')||($baris['gallery_culinary']=='-'))&&(($baris['gallery_culinary']=='')||($baris['gallery_culinary']=='-')))
                        {
                          echo "<div class='item active'><img src='img/noimage.jpg' ></div><div class=carousel-caption'></div>";
                        }
                        else
                        {
                          echo "<div class='item active'><img src=".$baris['gallery_culinary']." ></div><div class=carousel-caption'></div><div class='item'><img src=".$baris['gallery_culinary']." ></div><div class=carousel-caption'></div>";
                        }                              
                      } 
