...
$query="SELECT mosque.id,name,address,capacity, ST_X(ST_Centroid(mosque.geom)) AS lng, ST_Y(ST_CENTROID(mosque.geom)) As lat FROM mosque where mosque.id='$id' ";
...
<div class="row">
	<div class="col-lg-7 col-xs-7 col-r-0">
		<div class="box">
			...
			<div class="box-body">
				<table>
					<tbody  style='vertical-align:top;'>
						<tr><td><b>Name</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $name ?></td></tr>
			...
			<div class="box-footer">
				<div class="btn-group">
					<a href="?page=formeditatributmasjid&id=<?php echo $id ?>" class="btn btn-default"><i class="fa fa-edit"></i> Data atribut</a>
					<a href="?page=formeditspasialmasjid&id=<?php echo $id ?>" class="btn btn-default"><i class="fa fa-edit"></i> Data spasial</a>
				</div>
			</div><!-- /.box-footer-->
		</div><!-- /.box -->
	</div>
	<div class="col-lg-5 col-xs-5">
		<div class="box">
			...
			<div class="box-footer">
				<div class="btn-group">
					<a href="?page=formeditphotomasjid&id=<?php echo $id ?>" class="btn btn-primary"><i class=""></i> Upload Foto</a>
				</div>
			</div><!-- /.box-footer-->
		</div>
	</div>
