...
$query="SELECT greatcharacter.id, name, address, information, ST_X(ST_Centroid(greatcharacter.geom)) AS lng, ST_Y(ST_CENTROID(greatcharacter.geom)) As lat FROM greatcharacter where greatcharacter.id='$id' ";
...
<div class="row">
	<div class="col-lg-7 col-xs-7 col-r-0">
		<div class="box">
			...
			<div class="box-body">
				<table>
					<tbody  style='vertical-align:top;'>
						...
						<tr><td><b>Informastion<b> </td><td>: </td><td><?php echo $information ?></td></tr>
			...
			<div class="box-footer">
				<div class="btn-group">
					<a href="?page=formeditatributtokohbesar&id=<?php echo $id ?>" class="btn btn-default"><i class="fa fa-edit"></i> Data atribut</a>
					<a href="?page=formeditspasialtokohbesar&id=<?php echo $id ?>" class="btn btn-default"><i class="fa fa-edit"></i> Data spasial</a>
				</div>
			</div><!-- /.box-footer-->
		</div><!-- /.box -->
	</div>
	<div class="col-lg-5 col-xs-5">
		<div class="box">
			...
			<div class="box-footer">
				<div class="btn-group">
					<a href="?page=formeditphototokohbesar&id=<?php echo $id ?>" class="btn btn-primary"><i class=""></i> Upload Foto</a>
				</div>
			</div><!-- /.box-footer-->
		</div>
	</div>
