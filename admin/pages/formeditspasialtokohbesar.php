<?php
$id=$_GET['id'];
$sql = mysqli_query($conn, "SELECT name,ST_AsText(geom) as geom FROM greatcharacter where id='$id'");
	...
	<div class="">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title" style="text-transform:capitalize;">Ubah Data Spasial <?php echo $data['nama'] ?></h3>
			</div>
			<div class="box-body">
				...
				<form role="form" action="act/editspasialtokohbesarprocess.php" method="post">
					...
					<a href="?page=detailsouvenirs&id=<?php echo $id; ?>" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i> Kembali</a>
