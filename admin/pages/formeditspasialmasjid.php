<?php
$id=$_GET['id'];
$sql = mysqli_query($conn, "SELECT name,ST_AsText(geom) as geom FROM mosque where id='$id'");
	...
	<div class="">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<form role="form" action="act/editspasialmasjidprocess.php" method="post">
					...
					<a href="?page=detailmasjid&id=<?php echo $id; ?>" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i> Kembali</a>
