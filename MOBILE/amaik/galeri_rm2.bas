...
Sub fotoquery
	...
	ExecuteRemoteQuery("select distinct id_culinary, gallery_culinary from culinary_gallery where id_culinary='"&id&"'","ViewFoto")
End Sub
...
'			ResetImagesBackground
			...
			Else
				...
				For i=0 To agn.Size-1
					...
					w=agn.Get(i)	
					Log("haha")		
					Dim image = w.Get("gallery_culinary") As String
