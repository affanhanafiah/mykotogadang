...
public class ik_jeniss extends Activity implements B4AActivity{
	public static ik_jeniss mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.ik_jeniss");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ik_jeniss).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.ik_jeniss");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.ik_jeniss", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ik_jeniss) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ik_jeniss) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ik_jeniss) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _jenis1 = "";
public static String _jenisik1 = "";
public static anywheresoftware.b4a.objects.collections.Map _jenis_daftar = null;
public static String _id_jenis_industri = "";
public static String _nama_jenis_industri = "";
public static String _id = "";
public static String _idik = "";
public static String _nama_industri = "";
...
public static class _jenisik_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 37;BA.debugLine="Activity.LoadLayout(\"ik_jenis\")";
mostCurrent._activity.LoadLayout("ik_jenis",mostCurrent.activityBA);
 //BA.debugLineNum = 39;BA.debugLine="Panel1.Visible=False";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 40;BA.debugLine="daftarjenis";
_daftarjenis();
 //BA.debugLineNum = 42;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Colors";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (105),(int) (105),(int) (105)));
 //BA.debugLineNum = 43;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=16";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 45;BA.debugLine="Spinner1.DropdownBackgroundColor=Colors.RGB(255,";
mostCurrent._spinner1.setDropdownBackgroundColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 47;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
...
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 124;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 125;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 127;BA.debugLine="ExecuteRemoteQuery(\"Select distinct id, nama_indu";
_executeremotequery("Select distinct id, nama_industri, alamat, cp from industri_kecil_region, jenis_industri WHERE industri_kecil_region.id_jenis_industri='"+_idik+"' order by nama_industri asc","JENISIK1");
 //BA.debugLineNum = 128;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 66;BA.debugLine="Spinner1.Add(\"--Pilih Jenis--\")";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 68;BA.debugLine="ExecuteRemoteQuery(\"select * from jenis_industri\"";
_executeremotequery("select * from jenis_industri","JENIS1");
...
_job._initialize(processBA,_jobname,ik_jeniss.getObject());
...
mostCurrent._label2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Dim Label3 As Label";
mostCurrent._label3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Dim Panel1 As Panel";
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Dim Spinner1 As Spinner";
mostCurrent._spinner1 = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim ListView1 As ListView";
...
anywheresoftware.b4a.objects.collections.List _jenisik_array = null;
int _i = 0;
anywheresoftware.b4a.objects.collections.Map _a = null;
b4a.example.ik_jeniss._jenisik_lines _b = null;
...
switch (BA.switchObjectToInt(_job._jobname,_jenisik1,_jenis1)) {
case 0:
 //BA.debugLineNum = 81;BA.debugLine="Dim jenisik_array As List";
_jenisik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 82;BA.debugLine="jenisik_array = parser.NextArray";
_jenisik_array = _parser.NextArray();
 //BA.debugLineNum = 83;BA.debugLine="If jenisik_array.Size - 1 < 0 Then";
if (_jenisik_array.getSize()-1<0) { 
 //BA.debugLineNum = 84;BA.debugLine="Msgbox(\"Industri kecil tidak ditemukan\", \"Peri";
anywheresoftware.b4a.keywords.Common.Msgbox("Industri kecil tidak ditemukan","Peringatan",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 86;BA.debugLine="For i=0 To jenisik_array.Size -1";
{
final int step59 = 1;
final int limit59 = (int) (_jenisik_array.getSize()-1);
for (_i = (int) (0); (step59 > 0 && _i <= limit59) || (step59 < 0 && _i >= limit59); _i = ((int)(0 + _i + step59))) {
 //BA.debugLineNum = 87;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 88;BA.debugLine="a = jenisik_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenisik_array.Get(_i)));
 //BA.debugLineNum = 89;BA.debugLine="Dim b As jenisik_lines";
_b = new b4a.example.ik_jeniss._jenisik_lines();
 //BA.debugLineNum = 90;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 91;BA.debugLine="b.isi1 = a.Get(\"id\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 92;BA.debugLine="b.isi2 = a.Get(\"nama_industri\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("nama_industri")));
 //BA.debugLineNum = 93;BA.debugLine="b.isi3 = a.Get(\"alamat\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("alamat")));
 //BA.debugLineNum = 94;BA.debugLine="b.isi4 = a.Get(\"cp\")";
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 107;BA.debugLine="id_jenis_industri=a.Get(\"id_jenis_industri\")";
_id_jenis_industri = BA.ObjectToString(_a.Get((Object)("id_jenis_industri")));
 //BA.debugLineNum = 108;BA.debugLine="nama_jenis_industri=a.Get(\"nama_jenis_industr";
_nama_jenis_industri = BA.ObjectToString(_a.Get((Object)("nama_jenis_industri")));
 //BA.debugLineNum = 109;BA.debugLine="Spinner1.Add(nama_jenis_industri) 'meletakkan";
mostCurrent._spinner1.Add(_nama_jenis_industri);
 //BA.debugLineNum = 110;BA.debugLine="jenis_daftar.Put(nama_jenis_industri, id_jeni";
_jenis_daftar.Put((Object)(_nama_jenis_industri),(Object)(_id_jenis_industri));
 }
};
 };
 break;
...
b4a.example.ik_jeniss._jenisik_lines _b = null;
 ...
 //BA.debugLineNum = 131;BA.debugLine="Dim b As jenisik_lines";
_b = new b4a.example.ik_jeniss._jenisik_lines();
 //BA.debugLineNum = 132;BA.debugLine="b=Value";
_b = (b4a.example.ik_jeniss._jenisik_lines)(_value);
 //BA.debugLineNum = 133;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 134;BA.debugLine="nama_industri=b.isi2";
_nama_industri = _b.isi2;
 //BA.debugLineNum = 135;BA.debugLine="StartActivity(\"detailIK\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("detailIK"));
 //BA.debugLineNum = 136;BA.debugLine="End Sub";
return "";
}
public static String  _process_globals() throws Exception{
 //BA.debugLineNum = 6;BA.debugLine="Sub Process_Globals";
 //BA.debugLineNum = 10;BA.debugLine="Dim JENIS1 =\"JENIS1\" As String";
_jenis1 = "JENIS1";
 //BA.debugLineNum = 11;BA.debugLine="Dim JENISIK1 =\"JENISIK1\" As String";
_jenisik1 = "JENISIK1";
 //BA.debugLineNum = 12;BA.debugLine="Dim jenis_daftar As Map";
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jenisik_lines (isi1 As String,isi2 As String";
;
 //BA.debugLineNum = 14;BA.debugLine="Dim id_jenis_industri As String";
_id_jenis_industri = "";
 //BA.debugLineNum = 15;BA.debugLine="Dim nama_jenis_industri As String";
_nama_jenis_industri = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim id, idik As String 'id industri kecil";
_id = "";
_idik = "";
 //BA.debugLineNum = 17;BA.debugLine="Dim nama_industri As String";
_nama_industri = "";
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 120;BA.debugLine="idik= jenis_daftar.Get(Value) 'mengambil jenis da";
_idik = BA.ObjectToString(_jenis_daftar.Get(_value));
