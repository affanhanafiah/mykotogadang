...
public class radius_wis extends Activity implements B4AActivity{
	public static radius_wis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.radius_wis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (radius_wis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.radius_wis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.radius_wis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (radius_wis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (radius_wis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (radius_wis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _wis_lines{
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 129;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"wis_radius.php?";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"wis_radius.php?lat="+mostCurrent._dashboardd._latuser+"&lng="+mostCurrent._dashboardd._lnguser+"&rad="+BA.NumberToString(_radius1));
...
_job._initialize(processBA,_jobname,radius_wis.getObject());
...
b4a.example.radius_wis._wis_lines _b = null;
...
if (_mes_rad_array.getSize()-1<0) { 
 //BA.debugLineNum = 91;BA.debugLine="Msgbox(\"Tourism Not Found\", \"Notice\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Tourism Not Found","Notice",mostCurrent.activityBA);
 }else {
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_mes_rad_array.Get(_i)));
 //BA.debugLineNum = 98;BA.debugLine="Dim b As wis_lines";
_b = new b4a.example.radius_wis._wis_lines();
...
b4a.example.radius_wis._wis_lines _b = null;
 ...
 //BA.debugLineNum = 149;BA.debugLine="Dim b As wis_lines";
_b = new b4a.example.radius_wis._wis_lines();
 //BA.debugLineNum = 150;BA.debugLine="b=Value";
_b = (b4a.example.radius_wis._wis_lines)(_value);
...
anywheresoftware.b4a.keywords.Common.Log("posisi "+mostCurrent._dashboardd._latuser+" "+mostCurrent._dashboardd._lnguser);
 //BA.debugLineNum = 156;BA.debugLine="StartActivity(\"detail_wis\")";
...
_longitude = "";
_jarak = "";
 //BA.debugLineNum = 12;BA.debugLine="Type wis_lines (isi1 As String,isi2 As String,isi";
;
