...
public class rm_nama extends Activity implements B4AActivity{
	public static rm_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.rm_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (rm_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.rm_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.rm_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (rm_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (rm_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (rm_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"rm_nama\")";
mostCurrent._activity.LoadLayout("rm_nama",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 34;BA.debugLine="WebView1.Visible=False";
...
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (72),(int) (39),(int) (39)));
 //BA.debugLineNum = 38;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=16";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 39;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 41;BA.debugLine="EditText1.Color=Colors.RGB(167, 115, 93)";
...
public static String  _edittext1_enterpressed() throws Exception{
 ...
 //BA.debugLineNum = 102;BA.debugLine="inputnama11 = EditText1.Text";
_inputnama11 = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 103;BA.debugLine="Log(inputnama11)";
anywheresoftware.b4a.keywords.Common.Log(_inputnama11);
 //BA.debugLineNum = 104;BA.debugLine="iknama1";
_iknama1();
 //BA.debugLineNum = 105;BA.debugLine="Panel2.Visible=False";
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 107;BA.debugLine="WebView1.Visible=True";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 108;BA.debugLine="Label2.Visible=True";
mostCurrent._label2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 109;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"rm_nama.php?cari";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"rm_nama.php?cari_nama="+mostCurrent._edittext1.getText());
...
_job._initialize(processBA,_jobname,rm_nama.getObject());
...
_executeremotequery("SELECT distinct id, name,address, cp,price, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from culinary where lower(name) like lower('%"+_inputnama11+"%')","rm_nama");
...
anywheresoftware.b4a.objects.collections.List _rm_nama_array = null;
int _i = 0;
...
switch (BA.switchObjectToInt(_job._jobname,_rm_nama)) {
case 0:
 //BA.debugLineNum = 73;BA.debugLine="Dim rm_nama_array As List";
_rm_nama_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 74;BA.debugLine="rm_nama_array = parser.NextArray";
_rm_nama_array = _parser.NextArray();
 //BA.debugLineNum = 75;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 76;BA.debugLine="For i=0 To rm_nama_array.Size -1";
{
final int step50 = 1;
final int limit50 = (int) (_rm_nama_array.getSize()-1);
...
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 78;BA.debugLine="m = rm_nama_array.Get(i)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_rm_nama_array.Get(_i)));
...
_name = _b.isiKUL2;
 //BA.debugLineNum = 97;BA.debugLine="StartActivity(\"detail_rm\")";
...
_inputnama11 = "inputnama11";
 //BA.debugLineNum = 10;BA.debugLine="Private rm_nama = \"rm_nama\" As String";
_rm_nama = "rm_nama";
