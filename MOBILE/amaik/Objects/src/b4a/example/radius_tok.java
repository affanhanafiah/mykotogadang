...
public class radius_tok extends Activity implements B4AActivity{
	public static radius_tok mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.radius_tok");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (radius_tok).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.radius_tok");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.radius_tok", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (radius_tok) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (radius_tok) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (radius_tok) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _tok_lines{
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 129;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"tok_radius.php?";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"tok_radius.php?lat="+mostCurrent._dashboardd._latuser+"&lng="+mostCurrent._dashboardd._lnguser+"&rad="+BA.NumberToString(_radius1));
...
_job._initialize(processBA,_jobname,radius_tok.getObject());
...
b4a.example.radius_tok._tok_lines _b = null;
...
if (_mes_rad_array.getSize()-1<0) { 
 //BA.debugLineNum = 91;BA.debugLine="Msgbox(\"Great Character Not Found\", \"Notice\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Great Character Not Found","Notice",mostCurrent.activityBA);
 }else {
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_mes_rad_array.Get(_i)));
 //BA.debugLineNum = 98;BA.debugLine="Dim b As tok_lines";
_b = new b4a.example.radius_tok._tok_lines();
...
b4a.example.radius_tok._tok_lines _b = null;
 ...
 //BA.debugLineNum = 149;BA.debugLine="Dim b As tok_lines";
_b = new b4a.example.radius_tok._tok_lines();
 //BA.debugLineNum = 150;BA.debugLine="b=Value";
_b = (b4a.example.radius_tok._tok_lines)(_value);
...
anywheresoftware.b4a.keywords.Common.Log("posisi "+mostCurrent._dashboardd._latuser+" "+mostCurrent._dashboardd._lnguser);
 //BA.debugLineNum = 156;BA.debugLine="StartActivity(\"detail_tok\")";
...
_longitude = "";
_jarak = "";
 //BA.debugLineNum = 12;BA.debugLine="Type tok_lines (isi1 As String,isi2 As String,isi";
;
