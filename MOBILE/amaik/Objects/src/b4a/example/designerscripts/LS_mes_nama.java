...
views.get("listview1").vw.setTop((int)((17d / 100 * height)));
views.get("listview1").vw.setHeight((int)((52d / 100 * height) - ((17d / 100 * height))));
views.get("listview1").vw.setLeft((int)((0d / 100 * width)));
views.get("listview1").vw.setWidth((int)((100d / 100 * width) - ((0d / 100 * width))));
views.get("webview1").vw.setTop((int)((54d / 100 * height)));
views.get("webview1").vw.setHeight((int)((98d / 100 * height) - ((54d / 100 * height))));
