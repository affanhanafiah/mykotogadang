...
views.get("button1").vw.setLeft((int)((15d / 100 * width)));
views.get("button1").vw.setWidth((int)((41d / 100 * width) - ((15d / 100 * width))));
//BA.debugLineNum = 28;BA.debugLine="Button1.SetTopAndBottom(78%y,88%y)"[detailinfoik/General script]
views.get("button1").vw.setTop((int)((78d / 100 * height)));
views.get("button1").vw.setHeight((int)((88d / 100 * height) - ((78d / 100 * height))));
//BA.debugLineNum = 29;BA.debugLine="Button2.SetLeftAndRight(60%x,86%x)"[detailinfoik/General script]
views.get("button2").vw.setLeft((int)((60d / 100 * width)));
views.get("button2").vw.setWidth((int)((86d / 100 * width) - ((60d / 100 * width))));
//BA.debugLineNum = 30;BA.debugLine="Button2.SetTopAndBottom(78%y,88%y)"[detailinfoik/General script]
