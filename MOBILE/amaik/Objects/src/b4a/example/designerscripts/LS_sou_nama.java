...
views.get("label2").vw.setHeight((int)((50d / 100 * height) - ((40d / 100 * height))));
views.get("label2").vw.setLeft((int)((0d / 100 * width)));
views.get("label2").vw.setWidth((int)((100d / 100 * width) - ((0d / 100 * width))));
views.get("listview1").vw.setTop((int)((53d / 100 * height)));
views.get("listview1").vw.setHeight((int)((90d / 100 * height) - ((53d / 100 * height))));
