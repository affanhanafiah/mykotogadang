...
views.get("label1").vw.setWidth((int)((85d / 100 * width) - ((15d / 100 * width))));
...
views.get("button1").vw.setWidth((int)((85d / 100 * width) - ((10d / 100 * width))));
views.get("button1").vw.setTop((int)((30d / 100 * height)));
views.get("button1").vw.setHeight((int)((70d / 100 * height) - ((30d / 100 * height))));
views.get("label2").vw.setLeft((int)((15d / 100 * width)));
views.get("label2").vw.setWidth((int)((85d / 100 * width) - ((15d / 100 * width))));
views.get("label2").vw.setTop((int)((80d / 100 * height)));
views.get("label2").vw.setHeight((int)((20d / 100 * height) - ((80d / 100 * height))));
