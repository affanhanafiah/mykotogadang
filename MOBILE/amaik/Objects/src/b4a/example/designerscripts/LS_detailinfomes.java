...
views.get("label4").vw.setWidth((int)((40d / 100 * width) - ((18d / 100 * width))));
views.get("label4").vw.setTop((int)((52d / 100 * height)));
views.get("label4").vw.setHeight((int)((58d / 100 * height) - ((52d / 100 * height))));
views.get("label5").vw.setLeft((int)((41d / 100 * width)));
views.get("label5").vw.setWidth((int)((60d / 100 * width) - ((41d / 100 * width))));
views.get("label5").vw.setTop((int)((52d / 100 * height)));
views.get("label5").vw.setHeight((int)((58d / 100 * height) - ((52d / 100 * height))));
