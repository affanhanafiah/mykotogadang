...
views.get("label1").vw.setHeight((int)((17d / 100 * height) - ((5d / 100 * height))));
views.get("label1").vw.setLeft((int)((0d / 100 * width)));
views.get("label1").vw.setWidth((int)((100d / 100 * width) - ((0d / 100 * width))));
views.get("edittext1").vw.setTop((int)((19d / 100 * height)));
views.get("edittext1").vw.setHeight((int)((29d / 100 * height) - ((19d / 100 * height))));
views.get("edittext1").vw.setLeft((int)((0d / 100 * width)));
views.get("edittext1").vw.setWidth((int)((100d / 100 * width) - ((0d / 100 * width))));
views.get("label2").vw.setTop((int)((6d / 100 * height)));
views.get("label2").vw.setHeight((int)((15d / 100 * height) - ((6d / 100 * height))));
...
views.get("listview1").vw.setHeight((int)((55d / 100 * height) - ((25d / 100 * height))));
views.get("listview1").vw.setLeft((int)((0d / 100 * width)));
views.get("listview1").vw.setWidth((int)((100d / 100 * width) - ((0d / 100 * width))));
views.get("webview1").vw.setTop((int)((57d / 100 * height)));
views.get("webview1").vw.setHeight((int)((98d / 100 * height) - ((57d / 100 * height))));
