...
public class LS_detailinfoumkm{
...
views.get("label3").vw.setHeight((int)((50d / 100 * height) - ((40d / 100 * height))));
...
views.get("label4").vw.setHeight((int)((63d / 100 * height) - ((52d / 100 * height))));
...
views.get("button1").vw.setWidth((int)((45d / 100 * width) - ((10d / 100 * width))));
views.get("button1").vw.setTop((int)((75d / 100 * height)));
views.get("button1").vw.setHeight((int)((85d / 100 * height) - ((75d / 100 * height))));
views.get("button2").vw.setLeft((int)((58d / 100 * width)));
views.get("button2").vw.setWidth((int)((93d / 100 * width) - ((58d / 100 * width))));
views.get("button2").vw.setTop((int)((75d / 100 * height)));
views.get("button2").vw.setHeight((int)((85d / 100 * height) - ((75d / 100 * height))));
