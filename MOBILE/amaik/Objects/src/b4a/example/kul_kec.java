...
public class kul_kec extends Activity implements B4AActivity{
	public static kul_kec mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.kul_kec");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kul_kec).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.kul_kec");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.kul_kec", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kul_kec) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kul_kec) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kul_kec) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _jeniskeckul_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"kul_kec\")";
mostCurrent._activity.LoadLayout("kul_kec",mostCurrent.activityBA);
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 127;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct a.id, a.name,";
_executeremotequery("SELECT distinct a.id, a.name, a.address, a.cp, ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude from culinary_place as a, district WHERE st_contains(district.geom, a.geom) and district.id='"+_idkulkec+"' order by a.name asc","KECKUL11");
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 67;BA.debugLine="ExecuteRemoteQuery(\"select * from district\",\"KEC1";
_executeremotequery("select * from district","KEC11");
...
_job._initialize(processBA,_jobname,kul_kec.getObject());
...
b4a.example.kul_kec._jeniskeckul_lines _b = null;
...
if (_kecik_array.getSize()-1<0) { 
 //BA.debugLineNum = 83;BA.debugLine="Msgbox(\"Tidak ditemukan\", \"Peringatan\")";
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_kecik_array.Get(_i)));
 //BA.debugLineNum = 88;BA.debugLine="Dim b As jeniskeckul_lines";
_b = new b4a.example.kul_kec._jeniskeckul_lines();
...
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 91;BA.debugLine="b.isi2 = a.Get(\"name\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 92;BA.debugLine="b.isi3 = a.Get(\"address\")";
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 106;BA.debugLine="id=a.Get(\"id\")";
_id = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 107;BA.debugLine="name=a.Get(\"name\")";
_name = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 108;BA.debugLine="Spinner1.Add(name)";
mostCurrent._spinner1.Add(_name);
 //BA.debugLineNum = 109;BA.debugLine="jenis_daftar.Put(name, id)";
...
b4a.example.kul_kec._jeniskeckul_lines _b = null;
 ...
 //BA.debugLineNum = 132;BA.debugLine="Dim b As jeniskeckul_lines";
_b = new b4a.example.kul_kec._jeniskeckul_lines();
 //BA.debugLineNum = 133;BA.debugLine="b=Value";
_b = (b4a.example.kul_kec._jeniskeckul_lines)(_value);
 //BA.debugLineNum = 134;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 135;BA.debugLine="name=b.isi2";
_name = _b.isi2;
 //BA.debugLineNum = 136;BA.debugLine="StartActivity(\"detailKUL\")";
...
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jeniskeckul_lines (isi1 As String,isi2 As St";
;
 //BA.debugLineNum = 14;BA.debugLine="Dim id_kecamatan As String";
_id_kecamatan = "";
 //BA.debugLineNum = 15;BA.debugLine="Dim nama_kecamatan As String";
_nama_kecamatan = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim id, idkulkec As String";
_id = "";
_idkulkec = "";
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 119;BA.debugLine="idkulkec= jenis_daftar.Get(Value) 'mengambil jeni";
