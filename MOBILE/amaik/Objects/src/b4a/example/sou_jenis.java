...
public class sou_jenis extends Activity implements B4AActivity{
	public static sou_jenis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.sou_jenis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (sou_jenis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.sou_jenis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.sou_jenis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (sou_jenis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (sou_jenis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (sou_jenis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _jenissou1 = "";
public static anywheresoftware.b4a.objects.collections.Map _jenis_daftar = null;
public static String _id_jenis_oleh = "";
public static String _jenis_oleh = "";
public static String _id_oleh_oleh = "";
public static String _idsou = "";
...
public static class _jenissou_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"sou_jenis\")";
mostCurrent._activity.LoadLayout("sou_jenis",mostCurrent.activityBA);
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 126;BA.debugLine="ExecuteRemoteQuery(\"Select distinct id_oleh_oleh,";
_executeremotequery("Select distinct id_oleh_oleh, nama_oleh_oleh, alamat, cp from oleh_oleh, jenis_oleh_oleh WHERE oleh_oleh.id_jenis_oleh='"+_idsou+"' order by nama_oleh_oleh asc","JENISSOU1");
 //BA.debugLineNum = 127;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 64;BA.debugLine="Spinner1.Add(\"--Pilih Jenis--\")";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 66;BA.debugLine="ExecuteRemoteQuery(\"select * from jenis_oleh_oleh";
_executeremotequery("select * from jenis_oleh_oleh","JENIS1");
...
_job._initialize(processBA,_jobname,sou_jenis.getObject());
...
b4a.example.sou_jenis._jenissou_lines _b = null;
...
switch (BA.switchObjectToInt(_job._jobname,_jenissou1,_jenis1)) {
case 0:
 //BA.debugLineNum = 79;BA.debugLine="Dim jenisik_array As List";
_jenisik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 80;BA.debugLine="jenisik_array = parser.NextArray";
_jenisik_array = _parser.NextArray();
 //BA.debugLineNum = 81;BA.debugLine="If jenisik_array.Size - 1 < 0 Then";
...
anywheresoftware.b4a.keywords.Common.Msgbox("Tidak ditemukan","Peringatan",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 84;BA.debugLine="For i=0 To jenisik_array.Size -1";
{
final int step59 = 1;
...
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 86;BA.debugLine="a = jenisik_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenisik_array.Get(_i)));
 //BA.debugLineNum = 87;BA.debugLine="Dim b As jenissou_lines";
_b = new b4a.example.sou_jenis._jenissou_lines();
 //BA.debugLineNum = 88;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 89;BA.debugLine="b.isi1 = a.Get(\"id_oleh_oleh\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id_oleh_oleh")));
 //BA.debugLineNum = 90;BA.debugLine="b.isi2 = a.Get(\"nama_oleh_oleh\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("nama_oleh_oleh")));
 //BA.debugLineNum = 91;BA.debugLine="b.isi3 = a.Get(\"alamat\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("alamat")));
 //BA.debugLineNum = 92;BA.debugLine="b.isi4 = a.Get(\"cp\")";
_b.isi4 = BA.ObjectToString(_a.Get((Object)("cp")));
 //BA.debugLineNum = 93;BA.debugLine="ListView1.AddSingleLine2(b.isi2,b) 'meletakka";
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 105;BA.debugLine="id_jenis_oleh=a.Get(\"id_jenis_oleh\")";
_id_jenis_oleh = BA.ObjectToString(_a.Get((Object)("id_jenis_oleh")));
 //BA.debugLineNum = 106;BA.debugLine="jenis_oleh=a.Get(\"jenis_oleh\")";
_jenis_oleh = BA.ObjectToString(_a.Get((Object)("jenis_oleh")));
 //BA.debugLineNum = 107;BA.debugLine="Spinner1.Add(jenis_oleh) 'meletakkan namajeni";
mostCurrent._spinner1.Add(_jenis_oleh);
 //BA.debugLineNum = 108;BA.debugLine="jenis_daftar.Put(jenis_oleh, id_jenis_oleh)";
_jenis_daftar.Put((Object)(_jenis_oleh),(Object)(_id_jenis_oleh));
 }
};
 };
 break;
...
b4a.example.sou_jenis._jenissou_lines _b = null;
 //BA.debugLineNum = 128;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 130;BA.debugLine="Dim b As jenissou_lines";
_b = new b4a.example.sou_jenis._jenissou_lines();
 //BA.debugLineNum = 131;BA.debugLine="b=Value";
_b = (b4a.example.sou_jenis._jenissou_lines)(_value);
 //BA.debugLineNum = 132;BA.debugLine="id_oleh_oleh=b.isi1";
_id_oleh_oleh = _b.isi1;
 //BA.debugLineNum = 133;BA.debugLine="nama_oleh_oleh=b.isi2";
_nama_oleh_oleh = _b.isi2;
 //BA.debugLineNum = 134;BA.debugLine="StartActivity(\"detailSOUV\")";
...
_jenis1 = "JENIS1";
 //BA.debugLineNum = 11;BA.debugLine="Dim JENISSOU1 =\"JENISSOU1\" As String";
_jenissou1 = "JENISSOU1";
 //BA.debugLineNum = 12;BA.debugLine="Dim jenis_daftar As Map";
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jenissou_lines (isi1 As String,isi2 As Strin";
;
 //BA.debugLineNum = 14;BA.debugLine="Dim id_jenis_oleh As String";
_id_jenis_oleh = "";
 //BA.debugLineNum = 15;BA.debugLine="Dim jenis_oleh As String";
_jenis_oleh = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim id_oleh_oleh, idsou As String 'id industri ke";
_id_oleh_oleh = "";
_idsou = "";
 //BA.debugLineNum = 17;BA.debugLine="Dim nama_oleh_oleh As String";
_nama_oleh_oleh = "";
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 118;BA.debugLine="idsou= jenis_daftar.Get(Value) 'mengambil jenis d";
_idsou = BA.ObjectToString(_jenis_daftar.Get(_value));
