...
public class galeritok extends Activity implements B4AActivity{
	public static galeritok mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.galeritok");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (galeritok).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.galeritok");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.galeritok", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (galeritok) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (galeritok) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (galeritok) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("galeri",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="id=detail_tok.id";
_id = mostCurrent._detail_tok._id;
 //BA.debugLineNum = 29;BA.debugLine="detail_tok.id=\"\"";
mostCurrent._detail_tok._id = "";
...
_job._initialize(processBA,_jobname,galeritok.getObject());
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading");
 //BA.debugLineNum = 37;BA.debugLine="ExecuteRemoteQuery(\"select distinct id_greatchara";
_executeremotequery("select distinct id_greatcharacter, gallery_greatcharacter from greatcharacter_gallery where id_greatcharacter='"+_id+"'","ViewFoto");
...
anywheresoftware.b4a.keywords.Common.Log("haha");
 //BA.debugLineNum = 70;BA.debugLine="Dim image = w.Get(\"gallery_greatcharacter\") A";
_image = BA.ObjectToString(_w.Get((Object)("gallery_greatcharacter")));
