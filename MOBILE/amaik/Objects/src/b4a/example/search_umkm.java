...
public class search_umkm extends Activity implements B4AActivity{
	public static search_umkm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.search_umkm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (search_umkm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.search_umkm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.search_umkm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (search_umkm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (search_umkm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (search_umkm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"search_umkm\")";
mostCurrent._activity.LoadLayout("search_umkm",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="ListView1.Height=160dip";
mostCurrent._listview1.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (160)));
 //BA.debugLineNum = 28;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=40dip";
mostCurrent._listview1.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 29;BA.debugLine="ListView1.AddSingleLine(\"Based On Name\")";
mostCurrent._listview1.AddSingleLine("Based On Name");
 //BA.debugLineNum = 30;BA.debugLine="ListView1.AddSingleLine(\"Based On Product\")";
mostCurrent._listview1.AddSingleLine("Based On Product");
 //BA.debugLineNum = 31;BA.debugLine="ListView1.AddSingleLine(\"Based on Type\")";
mostCurrent._listview1.AddSingleLine("Based on Type");
 //BA.debugLineNum = 32;BA.debugLine="ListView1.AddSingleLine(\"Based on Radius\")";
mostCurrent._listview1.AddSingleLine("Based on Radius");
 //BA.debugLineNum = 33;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=14";
...
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (83),(int) (1),(int) (22)));
...
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 36;BA.debugLine="ListView1.Visible=False";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="If (ListView1.Visible=False) Then";
if ((mostCurrent._listview1.getVisible()==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 72;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 73;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 75;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 76;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim Panel1 As Panel";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub ImageView1_Click";
 //BA.debugLineNum = 83;BA.debugLine="End Sub";
return "";
}
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
String _menu = "";
 //BA.debugLineNum = 48;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 49;BA.debugLine="Dim menu = Value As String";
_menu = BA.ObjectToString(_value);
 //BA.debugLineNum = 50;BA.debugLine="Select menu";
switch (BA.switchObjectToInt(_menu,"Based On Name","Based On Product","Based on Type","Based on Radius")) {
case 0:
 //BA.debugLineNum = 52;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(\"umkm_nama\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("umkm_nama"));
 //BA.debugLineNum = 54;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 1:
 //BA.debugLineNum = 56;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(\"umkm_product\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("umkm_product"));
 //BA.debugLineNum = 58;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 2:
 //BA.debugLineNum = 60;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(\"umkm_tipe\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("umkm_tipe"));
 //BA.debugLineNum = 62;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 3:
 //BA.debugLineNum = 64;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(\"radius\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("radius"));
 //BA.debugLineNum = 66;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
}
;
