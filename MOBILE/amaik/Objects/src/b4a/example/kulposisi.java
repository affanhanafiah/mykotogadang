...
public class kulposisi extends Activity implements B4AActivity{
	public static kulposisi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.kulposisi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kulposisi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.kulposisi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.kulposisi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kulposisi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kulposisi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kulposisi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._dashboardd._lnguser);
 //BA.debugLineNum = 40;BA.debugLine="id_ik2=detail_rm.id";
_id_ik2 = mostCurrent._detail_rm._id;
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 144;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 145;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 147;BA.debugLine="ExecuteRemoteQuery(\"Select distinct angkot.id_ang";
_executeremotequery("Select distinct angkot.id_angkot,angkot.destination, angkot.cost, angkot.track,detail_culinary.lat, detail_culinary.long, st_x(st_centroid(angkot.geom)) As longitude,st_y(st_centroid(angkot.geom)) As latitude FROM angkot left join detail_culinary on angkot.id_angkot=detail_culinary.id_angkot where detail_culinary.id_culinary='"+_id_ik2+"'","ANGKOTIK");
 //BA.debugLineNum = 150;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 151;BA.debugLine="WebView2.Visible=False";
mostCurrent._webview2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 152;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 156;BA.debugLine="StartActivity(nearculinary)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._nearculinary.getObject()));
...
_job._initialize(processBA,_jobname,kulposisi.getObject());
...
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim Panel2 As Panel";
...
mostCurrent._webview1 = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim WebView2 As WebView";
...
{
final int step56 = 1;
final int limit56 = (int) (_angkotik_array.getSize()-1);
...
anywheresoftware.b4a.keywords.Common.Log(_latsimpang);
 //BA.debugLineNum = 138;BA.debugLine="WebView2.LoadUrl(Main.Server&\"petaSayarm.php?lat=";
mostCurrent._webview2.LoadUrl(mostCurrent._main._server+"petaSayarm.php?lat="+_lattujuan+"&lng="+_lngtujuan+"&warna="+_warna+"&id_angkot="+_id_angkot+"&latsimpang="+_latsimpang+"&lngsimpang="+_lngsimpang);
...
public static String  _posisi1() throws Exception{
 ...
 //BA.debugLineNum = 49;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"petaSayarm.php?l";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"petaSayarm.php?lat="+_lattujuan+"&lng="+_lngtujuan);
 //BA.debugLineNum = 50;BA.debugLine="Log(\"\"&Main.Server&\"petaSayarm.php?lat=\"&latTujua";
anywheresoftware.b4a.keywords.Common.Log(""+mostCurrent._main._server+"petaSayarm.php?lat="+_lattujuan+"&lng="+_lngtujuan);
