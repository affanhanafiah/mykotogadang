...
public class detail_tok extends Activity implements B4AActivity{
	public static detail_tok mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detail_tok");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detail_tok).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detail_tok");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detail_tok", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detail_tok) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detail_tok) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detail_tok) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
anywheresoftware.b4a.keywords.Common.Log("tipe umkm");
 ...
 //BA.debugLineNum = 50;BA.debugLine="Activity.LoadLayout(\"detailinfotok\")";
mostCurrent._activity.LoadLayout("detailinfotok",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 52;BA.debugLine="If  tok_nama.id<>\"\" Then";
if ((mostCurrent._tok_nama._id).equals("") == false) { 
 //BA.debugLineNum = 53;BA.debugLine="id_kul2=tok_nama.id";
mostCurrent._id_kul2 = mostCurrent._tok_nama._id;
...
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 }else if((mostCurrent._radius_tok._id).equals("") == false) { 
 //BA.debugLineNum = 63;BA.debugLine="id_kul2=radius_tok.id";
mostCurrent._id_kul2 = mostCurrent._radius_tok._id;
 //BA.debugLineNum = 64;BA.debugLine="Log(\"nama kul\")";
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 };
 //BA.debugLineNum = 67;BA.debugLine="kul_tem.id=\"\"";
mostCurrent._kul_tem._id = "";
 //BA.debugLineNum = 68;BA.debugLine="kul_kec.id=\"\"";
mostCurrent._kul_kec._id = "";
 //BA.debugLineNum = 69;BA.debugLine="kul_nama.id=\"\"";
mostCurrent._kul_nama._id = "";
 //BA.debugLineNum = 70;BA.debugLine="radius_tok.id=\"\"";
mostCurrent._radius_tok._id = "";
...
public static String  _bgalery_click() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub bGalery_Click 'activity menuju galeri ik";
 //BA.debugLineNum = 138;BA.debugLine="End Sub";
return "";
}
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 126;BA.debugLine="tokposisi.latTujuan=lat";
mostCurrent._tokposisi._lattujuan = _lat;
 //BA.debugLineNum = 127;BA.debugLine="tokposisi.lngTujuan=lng";
mostCurrent._tokposisi._lngtujuan = _lng;
 //BA.debugLineNum = 129;BA.debugLine="StartActivity(\"tokposisi\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("tokposisi"));
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 133;BA.debugLine="StartActivity(galeritok)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._galeritok.getObject()));
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 91;BA.debugLine="ExecuteRemoteQuery(\"Select id, name, address, inf";
_executeremotequery("Select id, name, address, information, st_x(st_centroid(geom)), st_y(st_centroid(geom)) from greatcharacter where greatcharacter.id='"+mostCurrent._id_kul2+"'","tok");
...
_job._initialize(processBA,_jobname,detail_tok.getObject());
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 139;BA.debugLine="Sub ImageView4_Click  'activity menuju halaman awa";
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(Main)";
...
switch (BA.switchObjectToInt(_job._jobname,_tok)) {
case 0:
...
mostCurrent._label3.setText(_m.Get((Object)("address")));
 //BA.debugLineNum = 113;BA.debugLine="Label4.Text=m.Get(\"information\")";
mostCurrent._label4.setText(_m.Get((Object)("information")));
 //BA.debugLineNum = 114;BA.debugLine="lng=m.Get(\"st_x\")";
_lng = BA.ObjectToString(_m.Get((Object)("st_x")));
 //BA.debugLineNum = 115;BA.debugLine="lat=m.Get(\"st_y\")";
_lat = BA.ObjectToString(_m.Get((Object)("st_y")));
 //BA.debugLineNum = 116;BA.debugLine="Log(Label2)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._label2));
 }else {
 //BA.debugLineNum = 118;BA.debugLine="Msgbox(\"No Data \",\"Info\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private tok=\"tok\" As String";
_tok = "tok";
