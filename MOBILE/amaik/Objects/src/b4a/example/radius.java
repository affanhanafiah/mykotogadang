...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 129;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"umkm_radius.php";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"umkm_radius.php?lat="+mostCurrent._dashboardd._latuser+"&lng="+mostCurrent._dashboardd._lnguser+"&rad="+BA.NumberToString(_radius1));
...
if (_mes_rad_array.getSize()-1<0) { 
 //BA.debugLineNum = 91;BA.debugLine="Msgbox(\"UMKM Not Found\", \"Notice\")";
anywheresoftware.b4a.keywords.Common.Msgbox("UMKM Not Found","Notice",mostCurrent.activityBA);
 }else {
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_mes_rad_array.Get(_i)));
 //BA.debugLineNum = 98;BA.debugLine="Dim b As mesjid_lines";
...
b4a.example.radius._mesjid_lines _b = null;
 ...
 //BA.debugLineNum = 149;BA.debugLine="Dim b As mesjid_lines";
_b = new b4a.example.radius._mesjid_lines();
...
anywheresoftware.b4a.keywords.Common.Log("posisi "+mostCurrent._dashboardd._latuser+" "+mostCurrent._dashboardd._lnguser);
 //BA.debugLineNum = 156;BA.debugLine="StartActivity(\"detail_umkm\")";
...
_longitude = "";
_jarak = "";
 //BA.debugLineNum = 12;BA.debugLine="Type mesjid_lines (isi1 As String,isi2 As String,";
;
