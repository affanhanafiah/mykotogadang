...
public class kul_fasilitas extends Activity implements B4AActivity{
	public static kul_fasilitas mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.kul_fasilitas");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kul_fasilitas).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.kul_fasilitas");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.kul_fasilitas", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kul_fasilitas) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kul_fasilitas) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kul_fasilitas) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _namafas1 = "";
public static String _jenisnamafas1 = "";
public static anywheresoftware.b4a.objects.collections.Map _jenis_daftarfas = null;
public static String _facility = "";
public static String _id = "";
public static String _idfacility = "";
...
public static class _jeniskulfas_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 39;BA.debugLine="Activity.LoadLayout(\"kul_fasilitas\")";
mostCurrent._activity.LoadLayout("kul_fasilitas",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub Button1_Click";
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 129;BA.debugLine="ExecuteRemoteQuery(\"select culinary_place.id,culi";
_executeremotequery("select culinary_place.id,culinary_place.name,culinary_place.address, culinary_place.cp, facility.facility, ST_X(ST_Centroid(culinary_place.geom)) AS lng, ST_Y(ST_CENTROID(culinary_place.geom)) As lat from culinary_place join detail_facility on culinary_place.id=detail_facility.id_culinary_place join facility on detail_facility.id_facility=facility.id where detail_facility.id_facility='"+_idfacility+"' order by name asc","JENISNAMAFAS1");
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 67;BA.debugLine="Spinner1.Add(\"--Pilih Jenis--\")";
mostCurrent._spinner1.Add("--Pilih Jenis--");
 //BA.debugLineNum = 68;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 69;BA.debugLine="ExecuteRemoteQuery(\"select * from facility\",\"NAMA";
_executeremotequery("select * from facility","NAMAFAS1");
...
_job._initialize(processBA,_jobname,kul_fasilitas.getObject());
...
mostCurrent._button1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Dim Label1 As Label";
...
mostCurrent._label3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim Panel1 As Panel";
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Dim Spinner1 As Spinner";
mostCurrent._spinner1 = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Dim ListView1 As ListView";
...
anywheresoftware.b4a.objects.collections.List _jeniskuliner_array = null;
int _i = 0;
anywheresoftware.b4a.objects.collections.Map _a = null;
b4a.example.kul_fasilitas._jeniskulfas_lines _b = null;
...
switch (BA.switchObjectToInt(_job._jobname,_jenisnamafas1,_namafas1)) {
case 0:
 //BA.debugLineNum = 82;BA.debugLine="Dim jeniskuliner_array As List";
_jeniskuliner_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 83;BA.debugLine="jeniskuliner_array = parser.NextArray";
_jeniskuliner_array = _parser.NextArray();
 //BA.debugLineNum = 84;BA.debugLine="If jeniskuliner_array.Size - 1 < 0 Then";
if (_jeniskuliner_array.getSize()-1<0) { 
 //BA.debugLineNum = 85;BA.debugLine="Msgbox(\"Tidak ditemukan\", \"Peringatan\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Tidak ditemukan","Peringatan",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 87;BA.debugLine="For i=0 To jeniskuliner_array.Size -1";
{
final int step60 = 1;
final int limit60 = (int) (_jeniskuliner_array.getSize()-1);
...
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 89;BA.debugLine="a = jeniskuliner_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jeniskuliner_array.Get(_i)));
 //BA.debugLineNum = 90;BA.debugLine="Dim b As jeniskulfas_lines";
_b = new b4a.example.kul_fasilitas._jeniskulfas_lines();
 //BA.debugLineNum = 91;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 92;BA.debugLine="b.isi1 = a.Get(\"id\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 93;BA.debugLine="b.isi2 = a.Get(\"name\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 94;BA.debugLine="b.isi3 = a.Get(\"address\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("address")));
 //BA.debugLineNum = 95;BA.debugLine="b.isi4 = a.Get(\"cp\")";
_b.isi4 = BA.ObjectToString(_a.Get((Object)("cp")));
 //BA.debugLineNum = 96;BA.debugLine="ListView1.AddSingleLine2(b.isi2,b)";
mostCurrent._listview1.AddSingleLine2(_b.isi2,(Object)(_b));
 ...
 break;
case 1:
 //BA.debugLineNum = 101;BA.debugLine="Dim jenis_array As List";
_jenis_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 102;BA.debugLine="jenis_daftarfas.Initialize";
_jenis_daftarfas.Initialize();
...
{
final int step77 = 1;
final int limit77 = (int) (_jenis_array.getSize()-1);
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 108;BA.debugLine="id=a.Get(\"id\")";
_id = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 109;BA.debugLine="facility=a.Get(\"facility\")";
_facility = BA.ObjectToString(_a.Get((Object)("facility")));
 //BA.debugLineNum = 110;BA.debugLine="Spinner1.Add(facility) 'meletakkan namajenis";
mostCurrent._spinner1.Add(_facility);
 //BA.debugLineNum = 111;BA.debugLine="jenis_daftarfas.Put(facility, id)";
_jenis_daftarfas.Put((Object)(_facility),(Object)(_id));
 }
};
 };
 break;
...
b4a.example.kul_fasilitas._jeniskulfas_lines _b = null;
 //BA.debugLineNum = 132;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 134;BA.debugLine="Dim b As jeniskulfas_lines";
_b = new b4a.example.kul_fasilitas._jeniskulfas_lines();
 //BA.debugLineNum = 135;BA.debugLine="b=Value";
_b = (b4a.example.kul_fasilitas._jeniskulfas_lines)(_value);
 //BA.debugLineNum = 136;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 137;BA.debugLine="name=b.isi2";
_name = _b.isi2;
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(\"detailKUL\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("detailKUL"));
 //BA.debugLineNum = 141;BA.debugLine="End Sub";
return "";
}
public static String  _process_globals() throws Exception{
 //BA.debugLineNum = 6;BA.debugLine="Sub Process_Globals";
 //BA.debugLineNum = 10;BA.debugLine="Dim NAMAFAS1 =\"NAMAFAS1\" As String";
_namafas1 = "NAMAFAS1";
 //BA.debugLineNum = 11;BA.debugLine="Dim JENISNAMAFAS1 =\"JENISNAMAFAS1\" As String";
_jenisnamafas1 = "JENISNAMAFAS1";
 //BA.debugLineNum = 12;BA.debugLine="Dim jenis_daftarfas As Map";
_jenis_daftarfas = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jeniskulfas_lines (isi1 As String,isi2 As St";
;
 //BA.debugLineNum = 15;BA.debugLine="Dim facility As String";
_facility = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim id, idfacility As String 'id industri kecil";
_id = "";
_idfacility = "";
 //BA.debugLineNum = 17;BA.debugLine="Dim name As String";
_name = "";
 //BA.debugLineNum = 18;BA.debugLine="Dim address As String";
_address = "";
 //BA.debugLineNum = 19;BA.debugLine="Dim cp As String";
_cp = "";
 //BA.debugLineNum = 21;BA.debugLine="End Sub";
return "";
}
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Sub Spinner1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 121;BA.debugLine="idfacility= jenis_daftarfas.Get(Value) 'mengambil";
_idfacility = BA.ObjectToString(_jenis_daftarfas.Get(_value));
