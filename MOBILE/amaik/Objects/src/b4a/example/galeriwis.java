...
public class galeriwis extends Activity implements B4AActivity{
	public static galeriwis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.galeriwis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (galeriwis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.galeriwis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.galeriwis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (galeriwis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (galeriwis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (galeriwis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("galeri",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="id=detail_wis.id";
_id = mostCurrent._detail_wis._id;
 //BA.debugLineNum = 29;BA.debugLine="detail_wis.id=\"\"";
mostCurrent._detail_wis._id = "";
...
_job._initialize(processBA,_jobname,galeriwis.getObject());
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading");
 //BA.debugLineNum = 37;BA.debugLine="ExecuteRemoteQuery(\"select distinct id_tourism, g";
_executeremotequery("select distinct id_tourism, gallery_tourism from tourism_gallery where id_tourism='"+_id+"'","ViewFoto");
...
anywheresoftware.b4a.keywords.Common.Log("haha");
 //BA.debugLineNum = 70;BA.debugLine="Dim image = w.Get(\"gallery_tourism\") As Strin";
