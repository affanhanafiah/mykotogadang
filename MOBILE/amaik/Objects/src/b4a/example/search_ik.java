...
public class search_ik extends Activity implements B4AActivity{
	public static search_ik mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.search_ik");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (search_ik).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.search_ik");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.search_ik", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (search_ik) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (search_ik) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (search_ik) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"search_ik\")";
mostCurrent._activity.LoadLayout("search_ik",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="ListView1.Height=160dip";
mostCurrent._listview1.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (160)));
 //BA.debugLineNum = 30;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=40dip";
mostCurrent._listview1.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 31;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Nama\")";
mostCurrent._listview1.AddSingleLine("Berdasarkan Nama");
 //BA.debugLineNum = 32;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Kecamatan\")";
mostCurrent._listview1.AddSingleLine("Berdasarkan Kecamatan");
 //BA.debugLineNum = 33;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Tipe\")";
mostCurrent._listview1.AddSingleLine("Berdasarkan Tipe");
 //BA.debugLineNum = 34;BA.debugLine="ListView1.AddSingleLine(\"Filter\")";
mostCurrent._listview1.AddSingleLine("Filter");
 //BA.debugLineNum = 36;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=14";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (14));
 //BA.debugLineNum = 37;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Colors";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (83),(int) (1),(int) (22)));
 //BA.debugLineNum = 38;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 39;BA.debugLine="ListView1.Visible=False";
...
String _menu = "";
 ...
 //BA.debugLineNum = 53;BA.debugLine="Dim menu = Value As String";
_menu = BA.ObjectToString(_value);
 //BA.debugLineNum = 54;BA.debugLine="Select menu";
switch (BA.switchObjectToInt(_menu,"Berdasarkan Tipe","Berdasarkan Kecamatan","Berdasarkan Nama")) {
case 0:
 //BA.debugLineNum = 56;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(\"ik_jenis\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("ik_jenis"));
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(\"ik_kec\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("ik_kec"));
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(\"ik_nama\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("ik_nama"));
