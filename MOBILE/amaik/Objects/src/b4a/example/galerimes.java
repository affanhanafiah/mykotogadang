...
public class galerimes extends Activity implements B4AActivity{
	public static galerimes mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.galerimes");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (galerimes).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.galerimes");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.galerimes", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (galerimes) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (galerimes) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (galerimes) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"galerimes\")";
mostCurrent._activity.LoadLayout("galerimes",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="id=detail_mes.id";
_id = mostCurrent._detail_mes._id;
 //BA.debugLineNum = 29;BA.debugLine="detail_mes.id=\"\"";
mostCurrent._detail_mes._id = "";
...
_job._initialize(processBA,_jobname,galerimes.getObject());
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading");
 //BA.debugLineNum = 37;BA.debugLine="ExecuteRemoteQuery(\"select distinct id_mosque, ga";
_executeremotequery("select distinct id_mosque, gallery_mosque from mosque_gallery where id_mosque='"+_id+"'","ViewFoto");
...
anywheresoftware.b4a.keywords.Common.Log("haha");
 //BA.debugLineNum = 70;BA.debugLine="Dim image = w.Get(\"gallery_mosque\") As String";
_image = BA.ObjectToString(_w.Get((Object)("gallery_mosque")));
