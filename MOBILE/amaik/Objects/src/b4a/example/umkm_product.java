...
public class umkm_product extends Activity implements B4AActivity{
	public static umkm_product mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.umkm_product");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (umkm_product).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.umkm_product");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.umkm_product", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (umkm_product) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (umkm_product) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (umkm_product) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _jenisumkm_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 39;BA.debugLine="Activity.LoadLayout(\"umkm_product\")";
mostCurrent._activity.LoadLayout("umkm_product",mostCurrent.activityBA);
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 128;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct a.id, a.name,";
_executeremotequery("SELECT distinct a.id, a.name, a.address, a.cp, ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude from umkm as a, detail_product WHERE a.id=detail_product.id_umkm and detail_product.id_product='"+_idkulkec+"' order by a.name asc","KECKUL11");
 //BA.debugLineNum = 129;BA.debugLine="WebView1.Visible=True";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 130;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"produk_umkm.php?";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"produk_umkm.php?cari_nama="+_idkulkec);
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 68;BA.debugLine="Spinner1.Add(\"--Choose Product--\")";
mostCurrent._spinner1.Add("--Choose Product--");
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 70;BA.debugLine="ExecuteRemoteQuery(\"select * from product\",\"KEC11";
_executeremotequery("select * from product","KEC11");
...
_job._initialize(processBA,_jobname,umkm_product.getObject());
...
b4a.example.umkm_product._jenisumkm_lines _b = null;
...
{
final int step61 = 1;
final int limit61 = (int) (_kecik_array.getSize()-1);
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_kecik_array.Get(_i)));
 //BA.debugLineNum = 91;BA.debugLine="Dim b As jenisumkm_lines";
_b = new b4a.example.umkm_product._jenisumkm_lines();
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 107;BA.debugLine="id=a.Get(\"id_product\")";
_id = BA.ObjectToString(_a.Get((Object)("id_product")));
...
b4a.example.umkm_product._jenisumkm_lines _b = null;
 //BA.debugLineNum = 133;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 135;BA.debugLine="Dim b As jenisumkm_lines";
_b = new b4a.example.umkm_product._jenisumkm_lines();
 //BA.debugLineNum = 136;BA.debugLine="b=Value";
_b = (b4a.example.umkm_product._jenisumkm_lines)(_value);
 //BA.debugLineNum = 137;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 138;BA.debugLine="name=b.isi2";
_name = _b.isi2;
 //BA.debugLineNum = 139;BA.debugLine="StartActivity(\"detail_umkm\")";
...
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 15;BA.debugLine="Type jenisumkm_lines (isi1 As String,isi2 As Stri";
;
