...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 31;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 32;BA.debugLine="StartActivity(search_cul)";
...
public static String  _button3_click() throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="StartActivity(search_ik)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._search_ik.getObject()));
 //BA.debugLineNum = 37;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 40;BA.debugLine="StartActivity(search_cul)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._search_cul.getObject()));
