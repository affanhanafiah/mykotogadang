...
public class mesposisi extends Activity implements B4AActivity{
	public static mesposisi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.mesposisi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mesposisi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.mesposisi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.mesposisi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mesposisi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mesposisi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mesposisi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="Activity.LoadLayout(\"posisiIK\")";
mostCurrent._activity.LoadLayout("posisiIK",mostCurrent.activityBA);
 //BA.debugLineNum = 36;BA.debugLine="latAsal=dashboardd.latUser";
_latasal = mostCurrent._dashboardd._latuser;
 //BA.debugLineNum = 37;BA.debugLine="lngAsal=dashboardd.lngUser";
_lngasal = mostCurrent._dashboardd._lnguser;
 //BA.debugLineNum = 38;BA.debugLine="Log(dashboardd.latUser)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._dashboardd._latuser);
 //BA.debugLineNum = 39;BA.debugLine="Log(dashboardd.lngUser)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._dashboardd._lnguser);
 //BA.debugLineNum = 40;BA.debugLine="id_ik2=detail_mes.id";
_id_ik2 = mostCurrent._detail_mes._id;
 //BA.debugLineNum = 41;BA.debugLine="detail_umkm.lng=\"\"";
mostCurrent._detail_umkm._lng = "";
 //BA.debugLineNum = 42;BA.debugLine="detail_umkm.lat=\"\"";
mostCurrent._detail_umkm._lat = "";
 //BA.debugLineNum = 43;BA.debugLine="mode=\"DRIVING\"";
_mode = "DRIVING";
 //BA.debugLineNum = 44;BA.debugLine="Panel1.Visible=False";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 45;BA.debugLine="posisi1";
_posisi1();
...
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 105;BA.debugLine="If latAsal==\"0\" And lngAsal==\"0\"   Then";
if ((_latasal).equals("0") && (_lngasal).equals("0")) { 
 //BA.debugLineNum = 106;BA.debugLine="Msgbox(\"Click My Location First!!\",\"Alert\")";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._main.getObject()));
 ...
 //BA.debugLineNum = 109;BA.debugLine="Dim lat As String";
_lat = "";
 //BA.debugLineNum = 110;BA.debugLine="Dim lng As String";
_lng = "";
 //BA.debugLineNum = 112;BA.debugLine="Log(\"jalan\")";
anywheresoftware.b4a.keywords.Common.Log("jalan");
 //BA.debugLineNum = 114;BA.debugLine="WebView2.LoadUrl(\"\"&Main.server&\"route.php?latAsa";
mostCurrent._webview2.LoadUrl(""+mostCurrent._main._server+"route.php?latAsal="+_latasal+"&lngAsal="+_lngasal+"&latTujuan="+_lattujuan+"&lngTujuan="+_lngtujuan+"&mode="+_mode);
 //BA.debugLineNum = 115;BA.debugLine="Log(\"jalan\")";
anywheresoftware.b4a.keywords.Common.Log("jalan");
 };
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 145;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 146;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 148;BA.debugLine="ExecuteRemoteQuery(\"Select distinct angkot.id_ang";
_executeremotequery("Select distinct angkot.id_angkot,angkot.destination, angkot.cost, angkot.track,detail_mosque.lat, detail_mosque.long, st_x(st_centroid(angkot.geom)) As longitude,st_y(st_centroid(angkot.geom)) As latitude FROM angkot left join detail_mosque on angkot.id_angkot=detail_mosque.id_angkot where detail_mosque.id_mosque='"+_id_ik2+"'","ANGKOTIK");
 //BA.debugLineNum = 151;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 152;BA.debugLine="WebView2.Visible=False";
mostCurrent._webview2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 153;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 155;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 17;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 18;BA.debugLine="StartActivity(nearmes)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._nearmes.getObject()));
...
_job._initialize(processBA,_jobname,mesposisi.getObject());
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Dim WebView1 As WebView";
mostCurrent._webview1 = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Dim WebView2 As WebView";
...
_res = _job._getstring();
 //BA.debugLineNum = 74;BA.debugLine="Log (\"Respon from server:\" & res)";
...
case 0:
 //BA.debugLineNum = 79;BA.debugLine="Dim angkotik_array As List";
_angkotik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 80;BA.debugLine="angkotik_array = parser.NextArray";
_angkotik_array = _parser.NextArray();
 //BA.debugLineNum = 81;BA.debugLine="For i=0 To angkotik_array.Size -1";
{
final int step57 = 1;
...
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 83;BA.debugLine="a = angkotik_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_angkotik_array.Get(_i)));
 //BA.debugLineNum = 84;BA.debugLine="Dim b As angkotik_lines";
_b = new b4a.example.umkm_posisi._angkotik_lines();
 //BA.debugLineNum = 85;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 86;BA.debugLine="b.isi1 = a.Get(\"id_angkot\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id_angkot")));
 //BA.debugLineNum = 87;BA.debugLine="b.isi2 = a.Get(\"destination\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("destination")));
 //BA.debugLineNum = 88;BA.debugLine="b.isi3 = a.Get(\"cost\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("cost")));
 //BA.debugLineNum = 89;BA.debugLine="b.isi4 = a.Get(\"track\")";
_b.isi4 = BA.ObjectToString(_a.Get((Object)("track")));
 //BA.debugLineNum = 90;BA.debugLine="latsimpang = a.Get(\"lat\")";
_latsimpang = BA.ObjectToString(_a.Get((Object)("lat")));
 //BA.debugLineNum = 91;BA.debugLine="lngsimpang = a.Get(\"long\")";
_lngsimpang = BA.ObjectToString(_a.Get((Object)("long")));
 //BA.debugLineNum = 92;BA.debugLine="ListView1.AddSingleLine2(b.isi2, b) 'meletakk";
mostCurrent._listview1.AddSingleLine2(_b.isi2,(Object)(_b));
 //BA.debugLineNum = 93;BA.debugLine="Log(b.isi2)";
...
b4a.example.umkm_posisi._angkotik_lines _b = null;
 ...
 //BA.debugLineNum = 122;BA.debugLine="WebView2.Visible=True";
mostCurrent._webview2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 123;BA.debugLine="Dim b As angkotik_lines";
_b = new b4a.example.umkm_posisi._angkotik_lines();
 //BA.debugLineNum = 124;BA.debugLine="b=Value";
_b = (b4a.example.umkm_posisi._angkotik_lines)(_value);
 //BA.debugLineNum = 125;BA.debugLine="id_angkot=b.isi1";
_id_angkot = _b.isi1;
 //BA.debugLineNum = 126;BA.debugLine="destination=b.isi2";
_destination = _b.isi2;
 //BA.debugLineNum = 127;BA.debugLine="warna=\"Red\"";
_warna = "Red";
...
mostCurrent._listview1.AddSingleLine(_b.isi4);
 //BA.debugLineNum = 133;BA.debugLine="Log (id_ik2)";
anywheresoftware.b4a.keywords.Common.Log(_id_ik2);
 //BA.debugLineNum = 134;BA.debugLine="Log(lngsimpang)";
anywheresoftware.b4a.keywords.Common.Log(_lngsimpang);
 //BA.debugLineNum = 135;BA.debugLine="Log(latsimpang)";
anywheresoftware.b4a.keywords.Common.Log(_latsimpang);
 //BA.debugLineNum = 137;BA.debugLine="WebView2.LoadUrl(Main.Server&\"petaSayames.php?lat";
mostCurrent._webview2.LoadUrl(mostCurrent._main._server+"petaSayames.php?lat="+_lattujuan+"&lng="+_lngtujuan+"&warna="+_warna+"&id_angkot="+_id_angkot+"&latsimpang="+_latsimpang+"&lngsimpang="+_lngsimpang);
 //BA.debugLineNum = 139;BA.debugLine="End Sub";
return "";
}
public static String  _posisi1() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub posisi1 'menampilkan industri kerajinan pada y";
 //BA.debugLineNum = 49;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"petaSayames.php?";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"petaSayames.php?lat="+_lattujuan+"&lng="+_lngtujuan);
 //BA.debugLineNum = 50;BA.debugLine="Log(\"\"&Main.Server&\"petaSayames.php?lat=\"&latTuju";
anywheresoftware.b4a.keywords.Common.Log(""+mostCurrent._main._server+"petaSayames.php?lat="+_lattujuan+"&lng="+_lngtujuan);
