...
public class kul_nama extends Activity implements B4AActivity{
	public static kul_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.kul_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kul_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.kul_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.kul_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kul_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kul_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kul_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _namakul1 = "";
public static String _jenisnama1 = "";
public static anywheresoftware.b4a.objects.collections.Map _jenis_daftarkul = null;
public static String _id = "";
public static String _name = "";
public static String _idkuliner = "";
...
public static class _jeniskulnama_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 39;BA.debugLine="Activity.LoadLayout(\"kul_nama\")";
mostCurrent._activity.LoadLayout("kul_nama",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 129;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 130;BA.debugLine="Panel2.Visible=False";
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 133;BA.debugLine="ExecuteRemoteQuery(\"select culinary_place.id,culi";
_executeremotequery("select culinary_place.id,culinary_place.name,culinary_place.address, culinary_place.cp, ST_X(ST_Centroid(culinary_place.geom)) AS lng, ST_Y(ST_CENTROID(culinary_place.geom)) As lat from culinary_place join detail_culinary on culinary_place.id=detail_culinary.id_culinary_place where detail_culinary.id_culinary='"+_idkuliner+"' order by name asc","JENISNAMA1");
 //BA.debugLineNum = 134;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 68;BA.debugLine="Spinner1.Add(\"--Pilih Jenis--\")";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 70;BA.debugLine="ExecuteRemoteQuery(\"select * from culinary\",\"NAMA";
_executeremotequery("select * from culinary","NAMAKUL1");
...
_job._initialize(processBA,_jobname,kul_nama.getObject());
...
b4a.example.kul_nama._jeniskulnama_lines _b = null;
...
switch (BA.switchObjectToInt(_job._jobname,_jenisnama1,_namakul1)) {
case 0:
 //BA.debugLineNum = 83;BA.debugLine="Dim jeniskuliner_array As List";
_jeniskuliner_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 84;BA.debugLine="jeniskuliner_array = parser.NextArray";
_jeniskuliner_array = _parser.NextArray();
 //BA.debugLineNum = 85;BA.debugLine="If jeniskuliner_array.Size - 1 < 0 Then";
...
anywheresoftware.b4a.keywords.Common.Msgbox("Tidak ditemukan","Peringatan",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 88;BA.debugLine="For i=0 To jeniskuliner_array.Size -1";
{
final int step62 = 1;
final int limit62 = (int) (_jeniskuliner_array.getSize()-1);
...
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 90;BA.debugLine="a = jeniskuliner_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jeniskuliner_array.Get(_i)));
 //BA.debugLineNum = 91;BA.debugLine="Dim b As jeniskulnama_lines";
_b = new b4a.example.kul_nama._jeniskulnama_lines();
...
_b.isi2 = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 95;BA.debugLine="b.isi3 = a.Get(\"address\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("address")));
 //BA.debugLineNum = 96;BA.debugLine="b.isi4 = a.Get(\"cp\")";
_b.isi4 = BA.ObjectToString(_a.Get((Object)("cp")));
 //BA.debugLineNum = 97;BA.debugLine="ListView1.AddSingleLine2(b.isi2,b)";
...
_jenis_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 103;BA.debugLine="jenis_daftarkul.Initialize";
_jenis_daftarkul.Initialize();
 //BA.debugLineNum = 104;BA.debugLine="jenis_array = parser.NextArray";
_jenis_array = _parser.NextArray();
 //BA.debugLineNum = 105;BA.debugLine="If(jenis_array.Size>0) Then";
if ((_jenis_array.getSize()>0)) { 
 //BA.debugLineNum = 106;BA.debugLine="For i=0 To jenis_array.Size -1";
{
final int step79 = 1;
final int limit79 = (int) (_jenis_array.getSize()-1);
for (_i = (int) (0); (step79 > 0 && _i <= limit79) || (step79 < 0 && _i >= limit79); _i = ((int)(0 + _i + step79))) {
 //BA.debugLineNum = 107;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 108;BA.debugLine="a = jenis_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 109;BA.debugLine="id=a.Get(\"id\")";
_id = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 110;BA.debugLine="name=a.Get(\"name\")";
_name = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 111;BA.debugLine="Spinner1.Add(name) 'meletakkan namajenis pada";
mostCurrent._spinner1.Add(_name);
 //BA.debugLineNum = 112;BA.debugLine="jenis_daftarkul.Put(name, id)";
_jenis_daftarkul.Put((Object)(_name),(Object)(_id));
 }
};
 };
 break;
...
;
 ...
 //BA.debugLineNum = 118;BA.debugLine="Job.Release";
_job._release();
...
b4a.example.kul_nama._jeniskulnama_lines _b = null;
 //BA.debugLineNum = 136;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 138;BA.debugLine="Dim b As jeniskulnama_lines";
_b = new b4a.example.kul_nama._jeniskulnama_lines();
 //BA.debugLineNum = 139;BA.debugLine="b=Value";
_b = (b4a.example.kul_nama._jeniskulnama_lines)(_value);
 //BA.debugLineNum = 140;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 141;BA.debugLine="name=b.isi2";
_name = _b.isi2;
 //BA.debugLineNum = 144;BA.debugLine="StartActivity(\"detailKUL\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 10;BA.debugLine="Dim NAMAKUL1 =\"NAMAKUL1\" As String";
_namakul1 = "NAMAKUL1";
 //BA.debugLineNum = 11;BA.debugLine="Dim JENISNAMA1 =\"JENISNAMA1\" As String";
_jenisnama1 = "JENISNAMA1";
 //BA.debugLineNum = 12;BA.debugLine="Dim jenis_daftarkul As Map";
_jenis_daftarkul = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jeniskulnama_lines (isi1 As String,isi2 As S";
;
 //BA.debugLineNum = 14;BA.debugLine="Dim id As String";
_id = "";
 //BA.debugLineNum = 15;BA.debugLine="Dim name As String";
_name = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim id, idkuliner As String 'id industri kecil";
_id = "";
_idkuliner = "";
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub Spinner1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 122;BA.debugLine="idkuliner= jenis_daftarkul.Get(Value) 'mengambil";
_idkuliner = BA.ObjectToString(_jenis_daftarkul.Get(_value));
