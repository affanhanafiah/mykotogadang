...
public class sou_nama extends Activity implements B4AActivity{
	public static sou_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.sou_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (sou_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.sou_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.sou_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (sou_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (sou_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (sou_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _sou_nama = "";
public static String _produk = "";
public static String _nama_oleh_oleh = "";
public static String _cp = "";
public static String _alamat = "";
...
public static class _daftarsou_lines{
public boolean IsInitialized;
public String isiIK1;
public String isiIK2;
public String isiIK3;
public String isiIK4;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"sou_nama\")";
mostCurrent._activity.LoadLayout("sou_nama",mostCurrent.activityBA);
 //BA.debugLineNum = 34;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Colors";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (72),(int) (39),(int) (39)));
 //BA.debugLineNum = 35;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=16";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 36;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 38;BA.debugLine="EditText1.Color=Colors.RGB(167, 115, 93)";
...
public static String  _edittext1_enterpressed() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub EditText1_EnterPressed";
 //BA.debugLineNum = 100;BA.debugLine="inputnama1 = EditText1.Text";
_inputnama1 = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 101;BA.debugLine="Log(inputnama1)";
anywheresoftware.b4a.keywords.Common.Log(_inputnama1);
 //BA.debugLineNum = 102;BA.debugLine="sounama1";
_sounama1();
...
anywheresoftware.b4a.samples.httputils2.httpjob _job = null;
 //BA.debugLineNum = 54;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 55;BA.debugLine="Dim Job As HttpJob";
_job = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 56;BA.debugLine="Job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,sou_nama.getObject());
 //BA.debugLineNum = 57;BA.debugLine="Job.PostString(\"\"&Main.Server&\"json.php\",Query)";
...
anywheresoftware.b4a.objects.collections.List _ik_nama_array = null;
int _i = 0;
anywheresoftware.b4a.objects.collections.Map _m = null;
b4a.example.sou_nama._daftarsou_lines _b = null;
 //BA.debugLineNum = 60;BA.debugLine="Sub JobDone(Job As HttpJob)";
 //BA.debugLineNum = 61;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 62;BA.debugLine="If Job.Success Then";
if (_job._success) { 
 //BA.debugLineNum = 63;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 64;BA.debugLine="res = Job.GetString";
_res = _job._getstring();
 //BA.debugLineNum = 65;BA.debugLine="Log(\"Response from server :\"& res)";
...
switch (BA.switchObjectToInt(_job._jobname,_sou_nama)) {
case 0:
 //BA.debugLineNum = 70;BA.debugLine="Dim ik_nama_array As List";
_ik_nama_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 71;BA.debugLine="ik_nama_array = parser.NextArray";
_ik_nama_array = _parser.NextArray();
 //BA.debugLineNum = 72;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 73;BA.debugLine="For i=0 To ik_nama_array.Size -1";
{
final int step47 = 1;
final int limit47 = (int) (_ik_nama_array.getSize()-1);
for (_i = (int) (0); (step47 > 0 && _i <= limit47) || (step47 < 0 && _i >= limit47); _i = ((int)(0 + _i + step47))) {
 //BA.debugLineNum = 74;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 75;BA.debugLine="m = ik_nama_array.Get(i)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_ik_nama_array.Get(_i)));
 //BA.debugLineNum = 76;BA.debugLine="Dim b As daftarsou_lines";
_b = new b4a.example.sou_nama._daftarsou_lines();
 //BA.debugLineNum = 77;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 78;BA.debugLine="b.isiIK1 = m.Get(\"id_oleh_oleh\")";
_b.isiIK1 = BA.ObjectToString(_m.Get((Object)("id_oleh_oleh")));
 //BA.debugLineNum = 79;BA.debugLine="b.isiIK2 = m.Get(\"nama_oleh_oleh\")";
_b.isiIK2 = BA.ObjectToString(_m.Get((Object)("nama_oleh_oleh")));
 //BA.debugLineNum = 80;BA.debugLine="b.isiIK3 = m.Get(\"latitude\")";
_b.isiIK3 = BA.ObjectToString(_m.Get((Object)("latitude")));
 //BA.debugLineNum = 81;BA.debugLine="b.isiIK4 = m.Get(\"longitude\")";
_b.isiIK4 = BA.ObjectToString(_m.Get((Object)("longitude")));
 //BA.debugLineNum = 82;BA.debugLine="ListView1.AddSingleLine2(b.isiIK2,b)";
mostCurrent._listview1.AddSingleLine2(_b.isiIK2,(Object)(_b));
 }
};
 break;
}
...
b4a.example.ik_nama._daftarik_lines _b = null;
String _id = "";
 //BA.debugLineNum = 88;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 89;BA.debugLine="Dim b As daftarik_lines";
_b = new b4a.example.ik_nama._daftarik_lines();
 //BA.debugLineNum = 90;BA.debugLine="b=Value";
_b = (b4a.example.ik_nama._daftarik_lines)(_value);
 //BA.debugLineNum = 91;BA.debugLine="id=b.isiIK1";
_id = _b.isiIK1;
 //BA.debugLineNum = 92;BA.debugLine="nama_oleh_oleh=b.isiIK2";
_nama_oleh_oleh = _b.isiIK2;
 //BA.debugLineNum = 95;BA.debugLine="StartActivity(\"detailSOUV\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 10;BA.debugLine="Private inputnama1 = \"inputnama1\" As String";
_inputnama1 = "inputnama1";
 //BA.debugLineNum = 11;BA.debugLine="Private sou_nama = \"sou_nama\" As String";
_sou_nama = "sou_nama";
 //BA.debugLineNum = 12;BA.debugLine="Dim produk, nama_oleh_oleh, cp, alamat, id_oleh_o";
_produk = "";
_nama_oleh_oleh = "";
_cp = "";
_alamat = "";
...
_latitude = "";
_longitude = "";
 //BA.debugLineNum = 13;BA.debugLine="Type daftarsou_lines (isiIK1 As String,isiIK2 As";
;
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public static String  _sounama1() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub sounama1";
 //BA.debugLineNum = 50;BA.debugLine="ProgressDialogShow(\"Loading...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading...");
 //BA.debugLineNum = 51;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct id_oleh_oleh,";
_executeremotequery("SELECT distinct id_oleh_oleh, nama_oleh_oleh,alamat, cp, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from oleh_oleh where lower(nama_oleh_oleh) like lower('%"+_inputnama1+"%')","sou_nama");
