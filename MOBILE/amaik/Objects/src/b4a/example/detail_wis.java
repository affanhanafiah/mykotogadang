...
public class detail_wis extends Activity implements B4AActivity{
	public static detail_wis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detail_wis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detail_wis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detail_wis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detail_wis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detail_wis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detail_wis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detail_wis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 39;BA.debugLine="If  wis_nama.id<>\"\" Then";
if ((mostCurrent._wis_nama._id).equals("") == false) { 
 //BA.debugLineNum = 40;BA.debugLine="id_kul2=wis_nama.id";
mostCurrent._id_kul2 = mostCurrent._wis_nama._id;
 //BA.debugLineNum = 41;BA.debugLine="Log(\"nama wiis\")";
anywheresoftware.b4a.keywords.Common.Log("nama wiis");
 //BA.debugLineNum = 42;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._umkm_product._id).equals("") == false) { 
 //BA.debugLineNum = 44;BA.debugLine="id_kul2=umkm_product.id";
mostCurrent._id_kul2 = mostCurrent._umkm_product._id;
 //BA.debugLineNum = 45;BA.debugLine="Log(\"product umkm\")";
anywheresoftware.b4a.keywords.Common.Log("product umkm");
 }else if((mostCurrent._umkm_tipe._id).equals("") == false) { 
 //BA.debugLineNum = 47;BA.debugLine="id_kul2=umkm_tipe.id";
mostCurrent._id_kul2 = mostCurrent._umkm_tipe._id;
 //BA.debugLineNum = 48;BA.debugLine="Log(\"tipe umkm\")";
anywheresoftware.b4a.keywords.Common.Log("tipe umkm");
 };
 };
 //BA.debugLineNum = 52;BA.debugLine="Activity.LoadLayout(\"detailinfowis\")";
mostCurrent._activity.LoadLayout("detailinfowis",mostCurrent.activityBA);
 //BA.debugLineNum = 53;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 54;BA.debugLine="If  wis_nama.id<>\"\" Then";
if ((mostCurrent._wis_nama._id).equals("") == false) { 
 //BA.debugLineNum = 55;BA.debugLine="id_kul2=wis_nama.id";
mostCurrent._id_kul2 = mostCurrent._wis_nama._id;
 //BA.debugLineNum = 56;BA.debugLine="Log(\"nama wis\")";
anywheresoftware.b4a.keywords.Common.Log("nama wis");
 //BA.debugLineNum = 57;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._wis_fas._id).equals("") == false) { 
 //BA.debugLineNum = 59;BA.debugLine="id_kul2=wis_fas.id";
mostCurrent._id_kul2 = mostCurrent._wis_fas._id;
 //BA.debugLineNum = 60;BA.debugLine="Log(\"wis fas\")";
anywheresoftware.b4a.keywords.Common.Log("wis fas");
 }else if((mostCurrent._radius_wis._id).equals("") == false) { 
 //BA.debugLineNum = 62;BA.debugLine="id_kul2=radius_wis.id";
mostCurrent._id_kul2 = mostCurrent._radius_wis._id;
 //BA.debugLineNum = 63;BA.debugLine="Log(\"rad wis\")";
anywheresoftware.b4a.keywords.Common.Log("rad wis");
 };
 //BA.debugLineNum = 66;BA.debugLine="kul_tem.id=\"\"";
mostCurrent._kul_tem._id = "";
 //BA.debugLineNum = 67;BA.debugLine="wis_fas.id=\"\"";
mostCurrent._wis_fas._id = "";
 //BA.debugLineNum = 68;BA.debugLine="kul_nama.id=\"\"";
mostCurrent._kul_nama._id = "";
 //BA.debugLineNum = 69;BA.debugLine="radius_wis.id=\"\"";
mostCurrent._radius_wis._id = "";
 //BA.debugLineNum = 71;BA.debugLine="detailKUL2";
_detailkul2();
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 127;BA.debugLine="wisposisi.latTujuan=lat";
mostCurrent._wisposisi._lattujuan = _lat;
 //BA.debugLineNum = 128;BA.debugLine="wisposisi.lngTujuan=lng";
mostCurrent._wisposisi._lngtujuan = _lng;
 //BA.debugLineNum = 130;BA.debugLine="StartActivity(\"wisposisi\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("wisposisi"));
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 133;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 134;BA.debugLine="StartActivity(galeriwis)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._galeriwis.getObject()));
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public static String  _detailkul2() throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub detailKUL2";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 90;BA.debugLine="ExecuteRemoteQuery(\"Select id, name, address, tic";
_executeremotequery("Select id, name, address, ticket,open,close,information,st_x(st_centroid(geom)), st_y(st_centroid(geom)) from tourism where tourism.id='"+mostCurrent._id_kul2+"'","wis");
 //BA.debugLineNum = 91;BA.debugLine="End Sub";
return "";
}
public static String  _executeremotequery(String _query,String _jobname) throws Exception{
anywheresoftware.b4a.samples.httputils2.httpjob _job = null;
 //BA.debugLineNum = 82;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 83;BA.debugLine="Dim Job As HttpJob";
_job = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 84;BA.debugLine="Job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,detail_wis.getObject());
 //BA.debugLineNum = 85;BA.debugLine="Job.PostString(\"\"&Main.server&\"json.php\", Query)";
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Dim ImageView2 As ImageView";
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim ImageView3 As ImageView";
mostCurrent._imageview3 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Dim ImageView4 As ImageView";
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Dim id_kul2 As String";
...
_res = "";
 //BA.debugLineNum = 97;BA.debugLine="res = Job.GetString";
...
switch (BA.switchObjectToInt(_job._jobname,_wis)) {
case 0:
 //BA.debugLineNum = 103;BA.debugLine="Dim umkm_array As List";
_umkm_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 104;BA.debugLine="umkm_array = parser.NextArray";
_umkm_array = _parser.NextArray();
 //BA.debugLineNum = 105;BA.debugLine="If (umkm_array.Size>0) Then";
if ((_umkm_array.getSize()>0)) { 
 //BA.debugLineNum = 106;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 108;BA.debugLine="m= umkm_array.Get(0)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_umkm_array.Get((int) (0))));
 //BA.debugLineNum = 109;BA.debugLine="id=m.Get(\"id\")";
_id = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 110;BA.debugLine="Label2.Text=m.Get(\"name\")";
mostCurrent._label2.setText(_m.Get((Object)("name")));
 //BA.debugLineNum = 111;BA.debugLine="Label3.Text=m.Get(\"address\")";
mostCurrent._label3.setText(_m.Get((Object)("address")));
 //BA.debugLineNum = 112;BA.debugLine="Label4.Text=m.Get(\"information\")";
mostCurrent._label4.setText(_m.Get((Object)("information")));
 //BA.debugLineNum = 113;BA.debugLine="Label5.Text=m.Get(\"open\")";
mostCurrent._label5.setText(_m.Get((Object)("open")));
 //BA.debugLineNum = 114;BA.debugLine="Label7.Text=m.Get(\"close\")";
mostCurrent._label7.setText(_m.Get((Object)("close")));
...
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._label2));
 ...
 //BA.debugLineNum = 119;BA.debugLine="Msgbox(\"No Data \",\"Info\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private wis=\"wis\" As String";
_wis = "wis";
