...
public class kul_tem extends Activity implements B4AActivity{
	public static kul_tem mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.kul_tem");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kul_tem).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.kul_tem");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.kul_tem", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kul_tem) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kul_tem) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kul_tem) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _daftarkul_lines{
public boolean IsInitialized;
public String isiKUL1;
public String isiKUL2;
public String isiKUL3;
public String isiKUL4;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="Activity.LoadLayout(\"kul_tem\")";
mostCurrent._activity.LoadLayout("kul_tem",mostCurrent.activityBA);
...
public static String  _edittext1_enterpressed() throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub EditText1_EnterPressed";
 //BA.debugLineNum = 99;BA.debugLine="inputnama11 = EditText1.Text";
_inputnama11 = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 100;BA.debugLine="Log(inputnama11)";
anywheresoftware.b4a.keywords.Common.Log(_inputnama11);
 //BA.debugLineNum = 101;BA.debugLine="iknama1";
_iknama1();
...
_job._initialize(processBA,_jobname,kul_tem.getObject());
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading...");
 //BA.debugLineNum = 51;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct id, name,addr";
_executeremotequery("SELECT distinct id, name,address, cp, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from culinary_place where lower(name) like lower('%"+_inputnama11+"%')","kul_tem");
...
switch (BA.switchObjectToInt(_job._jobname,_kul_tem)) {
case 0:
...
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_ik_nama_array.Get(_i)));
 //BA.debugLineNum = 76;BA.debugLine="Dim b As daftarkul_lines";
_b = new b4a.example.kul_tem._daftarkul_lines();
 //BA.debugLineNum = 77;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 78;BA.debugLine="b.isiKUL1 = m.Get(\"id\")";
_b.isiKUL1 = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 79;BA.debugLine="b.isiKUL2 = m.Get(\"name\")";
_b.isiKUL2 = BA.ObjectToString(_m.Get((Object)("name")));
 //BA.debugLineNum = 80;BA.debugLine="b.isiKUL3 = m.Get(\"latitude\")";
_b.isiKUL3 = BA.ObjectToString(_m.Get((Object)("latitude")));
 //BA.debugLineNum = 81;BA.debugLine="b.isiKUL4 = m.Get(\"longitude\")";
_b.isiKUL4 = BA.ObjectToString(_m.Get((Object)("longitude")));
 //BA.debugLineNum = 82;BA.debugLine="ListView1.AddSingleLine2(b.isiKUL2,b)";
...
b4a.example.kul_tem._daftarkul_lines _b = null;
 ...
 //BA.debugLineNum = 89;BA.debugLine="Dim b As daftarkul_lines";
_b = new b4a.example.kul_tem._daftarkul_lines();
 //BA.debugLineNum = 90;BA.debugLine="b=Value";
_b = (b4a.example.kul_tem._daftarkul_lines)(_value);
 //BA.debugLineNum = 91;BA.debugLine="id=b.isiKUL1";
_id = _b.isiKUL1;
 //BA.debugLineNum = 92;BA.debugLine="name=b.isiKUL2";
_name = _b.isiKUL2;
 //BA.debugLineNum = 94;BA.debugLine="StartActivity(\"detailKUL\")";
...
_inputnama11 = "inputnama11";
 //BA.debugLineNum = 10;BA.debugLine="Private kul_tem = \"kul_tem\" As String";
_kul_tem = "kul_tem";
...
_latitude = "";
_longitude = "";
 //BA.debugLineNum = 12;BA.debugLine="Type daftarkul_lines (isiKUL1 As String,isiKUL2 A";
;
