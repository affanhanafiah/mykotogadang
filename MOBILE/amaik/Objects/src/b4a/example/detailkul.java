...
public class detailkul extends Activity implements B4AActivity{
	public static detailkul mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detailkul");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detailkul).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detailkul");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detailkul", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detailkul) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detailkul) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detailkul) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 37;BA.debugLine="If  kul_tem.id<>\"\" Then";
if ((mostCurrent._kul_tem._id).equals("") == false) { 
 //BA.debugLineNum = 38;BA.debugLine="id_kul2=kul_tem.id";
mostCurrent._id_kul2 = mostCurrent._kul_tem._id;
 //BA.debugLineNum = 39;BA.debugLine="Log(\"nama tem\")";
anywheresoftware.b4a.keywords.Common.Log("nama tem");
 //BA.debugLineNum = 40;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._kul_kec._id).equals("") == false) { 
 //BA.debugLineNum = 42;BA.debugLine="id_kul2=kul_kec.id";
mostCurrent._id_kul2 = mostCurrent._kul_kec._id;
 //BA.debugLineNum = 43;BA.debugLine="Log(\"kecamatan kul\")";
anywheresoftware.b4a.keywords.Common.Log("kecamatan kul");
 }else if((mostCurrent._kul_nama._id).equals("") == false) { 
 //BA.debugLineNum = 45;BA.debugLine="id_kul2=kul_nama.id";
mostCurrent._id_kul2 = mostCurrent._kul_nama._id;
 //BA.debugLineNum = 46;BA.debugLine="Log(\"nama kul\")";
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 };
 };
 //BA.debugLineNum = 50;BA.debugLine="Activity.LoadLayout(\"detailinfokul\")";
mostCurrent._activity.LoadLayout("detailinfokul",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 52;BA.debugLine="If  kul_tem.id<>\"\" Then";
if ((mostCurrent._kul_tem._id).equals("") == false) { 
 //BA.debugLineNum = 53;BA.debugLine="id_kul2=kul_tem.id";
mostCurrent._id_kul2 = mostCurrent._kul_tem._id;
 //BA.debugLineNum = 54;BA.debugLine="Log(\"nama tem\")";
anywheresoftware.b4a.keywords.Common.Log("nama tem");
 //BA.debugLineNum = 55;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._kul_kec._id).equals("") == false) { 
 //BA.debugLineNum = 57;BA.debugLine="id_kul2=kul_kec.id";
mostCurrent._id_kul2 = mostCurrent._kul_kec._id;
 //BA.debugLineNum = 58;BA.debugLine="Log(\"kecamatan kul\")";
anywheresoftware.b4a.keywords.Common.Log("kecamatan kul");
 }else if((mostCurrent._kul_nama._id).equals("") == false) { 
...
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 ...
 //BA.debugLineNum = 64;BA.debugLine="kul_tem.id=\"\"";
mostCurrent._kul_tem._id = "";
 //BA.debugLineNum = 65;BA.debugLine="kul_kec.id=\"\"";
mostCurrent._kul_kec._id = "";
 //BA.debugLineNum = 66;BA.debugLine="kul_nama.id=\"\"";
mostCurrent._kul_nama._id = "";
 //BA.debugLineNum = 68;BA.debugLine="detailKUL2";
_detailkul2();
...
public static String  _bgalery_click() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Sub bGalery_Click 'activity menuju galeri ik";
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 123;BA.debugLine="ikposisi.latTujuan=lat";
mostCurrent._ikposisi._lattujuan = _lat;
 //BA.debugLineNum = 124;BA.debugLine="ikposisi.lngTujuan=lng";
mostCurrent._ikposisi._lngtujuan = _lng;
 //BA.debugLineNum = 126;BA.debugLine="StartActivity(\"ikposisi\")";
...
public static String  _detailkul2() throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Sub detailKUL2";
 //BA.debugLineNum = 86;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 87;BA.debugLine="ExecuteRemoteQuery(\"Select id, name, address, cp,";
_executeremotequery("Select id, name, address, cp, capacity, st_x(st_centroid(geom)), st_y(st_centroid(geom)) from culinary_place where culinary_place.id='"+mostCurrent._id_kul2+"'","KUL");
 //BA.debugLineNum = 88;BA.debugLine="End Sub";
return "";
}
public static String  _executeremotequery(String _query,String _jobname) throws Exception{
anywheresoftware.b4a.samples.httputils2.httpjob _job = null;
 //BA.debugLineNum = 79;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 80;BA.debugLine="Dim Job As HttpJob";
_job = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 81;BA.debugLine="Job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,detailkul.getObject());
 //BA.debugLineNum = 82;BA.debugLine="Job.PostString(\"\"&Main.server&\"json.php\", Query)";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub ImageView4_Click  'activity menuju halaman awa";
...
_res = "";
 //BA.debugLineNum = 94;BA.debugLine="res = Job.GetString";
...
switch (BA.switchObjectToInt(_job._jobname,_kul)) {
case 0:
 //BA.debugLineNum = 100;BA.debugLine="Dim ik_array As List";
_ik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 101;BA.debugLine="ik_array = parser.NextArray";
_ik_array = _parser.NextArray();
 //BA.debugLineNum = 102;BA.debugLine="If (ik_array.Size>0) Then";
if ((_ik_array.getSize()>0)) { 
 //BA.debugLineNum = 103;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 105;BA.debugLine="m= ik_array.Get(0)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_ik_array.Get((int) (0))));
 //BA.debugLineNum = 106;BA.debugLine="id=m.Get(\"id\")";
_id = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 107;BA.debugLine="Label2.Text=m.Get(\"name\")";
mostCurrent._label2.setText(_m.Get((Object)("name")));
 //BA.debugLineNum = 108;BA.debugLine="Label3.Text=m.Get(\"address\")";
mostCurrent._label3.setText(_m.Get((Object)("address")));
 //BA.debugLineNum = 109;BA.debugLine="Label4.Text=m.Get(\"cp\")";
mostCurrent._label4.setText(_m.Get((Object)("cp")));
 //BA.debugLineNum = 110;BA.debugLine="Label5.Text=m.Get(\"capacity\")";
mostCurrent._label5.setText(_m.Get((Object)("capacity")));
 //BA.debugLineNum = 111;BA.debugLine="lng=m.Get(\"st_x\")";
_lng = BA.ObjectToString(_m.Get((Object)("st_x")));
 //BA.debugLineNum = 112;BA.debugLine="lat=m.Get(\"st_y\")";
_lat = BA.ObjectToString(_m.Get((Object)("st_y")));
 //BA.debugLineNum = 113;BA.debugLine="Log(Label2)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._label2));
 }else {
 //BA.debugLineNum = 115;BA.debugLine="Msgbox(\"Data Tidak Ada\",\"Info\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private KUL=\"KUL\" As String";
_kul = "KUL";
