...
public class tok_nama extends Activity implements B4AActivity{
	public static tok_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.tok_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tok_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.tok_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.tok_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tok_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tok_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tok_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _tok_nama = "";
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"tok_nama\")";
mostCurrent._activity.LoadLayout("tok_nama",mostCurrent.activityBA);
...
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 37;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Color";
...
anywheresoftware.b4a.keywords.Common.Log(_inputnama11);
 //BA.debugLineNum = 104;BA.debugLine="WebView1.Visible=True";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 105;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 106;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 107;BA.debugLine="Label1.Visible=False";
...
mostCurrent._label2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 109;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"tok_nama.php?car";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"tok_nama.php?cari_nama="+mostCurrent._edittext1.getText());
 //BA.debugLineNum = 110;BA.debugLine="iknama1";
_iknama1();
...
_job._initialize(processBA,_jobname,tok_nama.getObject());
...
_executeremotequery("SELECT distinct id, name,address, information, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from greatcharacter where lower(name) like lower('%"+_inputnama11+"%')","tok_nama");
...
switch (BA.switchObjectToInt(_job._jobname,_tok_nama)) {
case 0:
...
_name = _b.isiKUL2;
 //BA.debugLineNum = 97;BA.debugLine="StartActivity(\"detail_tok\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("detail_tok"));
...
_inputnama11 = "inputnama11";
 //BA.debugLineNum = 10;BA.debugLine="Private tok_nama = \"tok_nama\" As String";
_tok_nama = "tok_nama";
