...
public class detail_rm extends Activity implements B4AActivity{
	public static detail_rm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detail_rm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detail_rm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detail_rm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detail_rm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detail_rm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detail_rm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detail_rm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 42;BA.debugLine="If  rm_nama.id<>\"\" Then";
if ((mostCurrent._rm_nama._id).equals("") == false) { 
 //BA.debugLineNum = 43;BA.debugLine="id_kul2=rm_nama.id";
mostCurrent._id_kul2 = mostCurrent._rm_nama._id;
 //BA.debugLineNum = 44;BA.debugLine="Log(\"nama rm\")";
anywheresoftware.b4a.keywords.Common.Log("nama rm");
 //BA.debugLineNum = 45;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._rm_menu._id).equals("") == false) { 
 //BA.debugLineNum = 47;BA.debugLine="id_kul2=rm_menu.id";
mostCurrent._id_kul2 = mostCurrent._rm_menu._id;
 //BA.debugLineNum = 48;BA.debugLine="Log(\"menu rm\")";
anywheresoftware.b4a.keywords.Common.Log("menu rm");
 }else if((mostCurrent._umkm_tipe._id).equals("") == false) { 
 //BA.debugLineNum = 50;BA.debugLine="id_kul2=umkm_tipe.id";
mostCurrent._id_kul2 = mostCurrent._umkm_tipe._id;
 //BA.debugLineNum = 51;BA.debugLine="Log(\"tipe umkm\")";
anywheresoftware.b4a.keywords.Common.Log("tipe umkm");
 };
 };
 //BA.debugLineNum = 55;BA.debugLine="Activity.LoadLayout(\"detailinform\")";
mostCurrent._activity.LoadLayout("detailinform",mostCurrent.activityBA);
 //BA.debugLineNum = 56;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 57;BA.debugLine="If  rm_nama.id<>\"\" Then";
if ((mostCurrent._rm_nama._id).equals("") == false) { 
 //BA.debugLineNum = 58;BA.debugLine="id_kul2=rm_nama.id";
mostCurrent._id_kul2 = mostCurrent._rm_nama._id;
 //BA.debugLineNum = 59;BA.debugLine="Log(\"nama rm\")";
anywheresoftware.b4a.keywords.Common.Log("nama rm");
 //BA.debugLineNum = 60;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._rm_menu._id).equals("") == false) { 
 //BA.debugLineNum = 62;BA.debugLine="id_kul2=rm_menu.id";
mostCurrent._id_kul2 = mostCurrent._rm_menu._id;
 //BA.debugLineNum = 63;BA.debugLine="Log(\"menu rm\")";
anywheresoftware.b4a.keywords.Common.Log("menu rm");
 }else if((mostCurrent._kul_nama._id).equals("") == false) { 
 //BA.debugLineNum = 65;BA.debugLine="id_kul2=kul_nama.id";
mostCurrent._id_kul2 = mostCurrent._kul_nama._id;
 //BA.debugLineNum = 66;BA.debugLine="Log(\"nama kul\")";
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 }else if((mostCurrent._radius_rm._id).equals("") == false) { 
 //BA.debugLineNum = 68;BA.debugLine="id_kul2=radius_rm.id";
mostCurrent._id_kul2 = mostCurrent._radius_rm._id;
 //BA.debugLineNum = 69;BA.debugLine="Log(\"nama kul\")";
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 };
 //BA.debugLineNum = 72;BA.debugLine="kul_tem.id=\"\"";
mostCurrent._kul_tem._id = "";
 //BA.debugLineNum = 73;BA.debugLine="kul_kec.id=\"\"";
mostCurrent._kul_kec._id = "";
 //BA.debugLineNum = 74;BA.debugLine="kul_nama.id=\"\"";
mostCurrent._kul_nama._id = "";
 //BA.debugLineNum = 75;BA.debugLine="radius_rm.id=\"\"";
mostCurrent._radius_rm._id = "";
 //BA.debugLineNum = 77;BA.debugLine="detailKUL2";
_detailkul2();
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 134;BA.debugLine="kulposisi.latTujuan=lat";
mostCurrent._kulposisi._lattujuan = _lat;
 //BA.debugLineNum = 135;BA.debugLine="kulposisi.lngTujuan=lng";
mostCurrent._kulposisi._lngtujuan = _lng;
 //BA.debugLineNum = 137;BA.debugLine="StartActivity(\"kulposisi\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("kulposisi"));
 //BA.debugLineNum = 138;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 140;BA.debugLine="Sub Button2_Click 'activity menuju galeri ik";
 //BA.debugLineNum = 141;BA.debugLine="StartActivity(galeri_rm2)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._galeri_rm2.getObject()));
 //BA.debugLineNum = 142;BA.debugLine="End Sub";
return "";
}
public static String  _detailkul2() throws Exception{
 //BA.debugLineNum = 94;BA.debugLine="Sub detailKUL2";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 96;BA.debugLine="ExecuteRemoteQuery(\"Select id, name, address, spe";
_executeremotequery("Select id, name, address, special_menu, price,open,close, st_x(st_centroid(geom)), st_y(st_centroid(geom)) from culinary where culinary.id='"+mostCurrent._id_kul2+"'","rm");
...
_job._initialize(processBA,_jobname,detail_rm.getObject());
 //BA.debugLineNum = 91;BA.debugLine="Job.PostString(\"\"&Main.server&\"json.php\", Query)";
...
mostCurrent._label5 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim Label6 As Label";
mostCurrent._label6 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim Label7 As Label";
mostCurrent._label7 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Dim Label8 As Label";
...
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Dim ImageView3 As ImageView";
mostCurrent._imageview3 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Dim ImageView4 As ImageView";
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Dim ImageView5 As ImageView";
mostCurrent._imageview5 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Dim id_kul2 As String";
mostCurrent._id_kul2 = "";
 //BA.debugLineNum = 37;BA.debugLine="End Sub";
return "";
}
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub ImageView4_Click  'activity menuju halaman awa";
...
anywheresoftware.b4a.objects.collections.Map _m = null;
 //BA.debugLineNum = 99;BA.debugLine="Sub JobDone(Job As HttpJob)";
 //BA.debugLineNum = 100;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 101;BA.debugLine="If Job.Success Then";
if (_job._success) { 
 //BA.debugLineNum = 102;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 103;BA.debugLine="res = Job.GetString";
...
anywheresoftware.b4a.keywords.Common.Log("Response from server :"+_res);
 //BA.debugLineNum = 105;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 106;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 //BA.debugLineNum = 107;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname,_rm)) {
case 0:
 //BA.debugLineNum = 109;BA.debugLine="Dim umkm_array As List";
_umkm_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 110;BA.debugLine="umkm_array = parser.NextArray";
_umkm_array = _parser.NextArray();
 //BA.debugLineNum = 111;BA.debugLine="If (umkm_array.Size>0) Then";
if ((_umkm_array.getSize()>0)) { 
 //BA.debugLineNum = 112;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 114;BA.debugLine="m= umkm_array.Get(0)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_umkm_array.Get((int) (0))));
 //BA.debugLineNum = 115;BA.debugLine="id=m.Get(\"id\")";
_id = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 116;BA.debugLine="Label2.Text=m.Get(\"name\")";
mostCurrent._label2.setText(_m.Get((Object)("name")));
 //BA.debugLineNum = 117;BA.debugLine="Label3.Text=m.Get(\"address\")";
mostCurrent._label3.setText(_m.Get((Object)("address")));
 //BA.debugLineNum = 118;BA.debugLine="Label4.Text=m.Get(\"special_menu\")";
mostCurrent._label4.setText(_m.Get((Object)("special_menu")));
 //BA.debugLineNum = 119;BA.debugLine="Label5.Text=m.Get(\"price\")";
mostCurrent._label5.setText(_m.Get((Object)("price")));
 //BA.debugLineNum = 120;BA.debugLine="Label6.Text=m.Get(\"open\")";
mostCurrent._label6.setText(_m.Get((Object)("open")));
 //BA.debugLineNum = 121;BA.debugLine="Label8.Text=m.Get(\"close\")";
mostCurrent._label8.setText(_m.Get((Object)("close")));
 //BA.debugLineNum = 122;BA.debugLine="lng=m.Get(\"st_x\")";
_lng = BA.ObjectToString(_m.Get((Object)("st_x")));
 //BA.debugLineNum = 123;BA.debugLine="lat=m.Get(\"st_y\")";
_lat = BA.ObjectToString(_m.Get((Object)("st_y")));
 //BA.debugLineNum = 124;BA.debugLine="Log(Label2)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._label2));
 }else {
 //BA.debugLineNum = 126;BA.debugLine="Msgbox(\"No Data \",\"Info\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private rm=\"rm\" As String";
_rm = "rm";
