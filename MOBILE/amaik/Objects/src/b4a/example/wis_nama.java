...
public class wis_nama extends Activity implements B4AActivity{
	public static wis_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.wis_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (wis_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.wis_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.wis_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (wis_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (wis_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (wis_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _wis_nama = "";
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"wis_nama\")";
mostCurrent._activity.LoadLayout("wis_nama",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="WebView1.Visible=False";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 34;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 35;BA.debugLine="Label2.Visible=False";
mostCurrent._label2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 36;BA.debugLine="Panel2.Visible=True";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 38;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Colors";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (72),(int) (39),(int) (39)));
 //BA.debugLineNum = 39;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=16";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 40;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 42;BA.debugLine="EditText1.Color=Colors.RGB(167, 115, 93)";
...
public static String  _edittext1_enterpressed() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub EditText1_EnterPressed";
...
anywheresoftware.b4a.keywords.Common.Log(_inputnama11);
 //BA.debugLineNum = 105;BA.debugLine="WebView1.Visible=True";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 106;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 107;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 108;BA.debugLine="Label1.Visible=False";
...
mostCurrent._label2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 110;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"wis_nama.php?car";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"wis_nama.php?cari_nama="+mostCurrent._edittext1.getText());
 //BA.debugLineNum = 111;BA.debugLine="iknama1";
_iknama1();
...
_job._initialize(processBA,_jobname,wis_nama.getObject());
...
public static String  _iknama1() throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub iknama1";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading...");
 //BA.debugLineNum = 55;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct id, name,addr";
_executeremotequery("SELECT distinct id, name,address, ticket,open,close,information, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from tourism where lower(name) like lower('%"+_inputnama11+"%')","wis_nama");
...
switch (BA.switchObjectToInt(_job._jobname,_wis_nama)) {
case 0:
 //BA.debugLineNum = 74;BA.debugLine="Dim umkm_nama_array As List";
_umkm_nama_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 75;BA.debugLine="umkm_nama_array = parser.NextArray";
_umkm_nama_array = _parser.NextArray();
 //BA.debugLineNum = 76;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 77;BA.debugLine="For i=0 To umkm_nama_array.Size -1";
{
final int step51 = 1;
...
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 79;BA.debugLine="m = umkm_nama_array.Get(i)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_umkm_nama_array.Get(_i)));
 //BA.debugLineNum = 80;BA.debugLine="Dim b As daftarkul_lines";
_b = new b4a.example.kul_tem._daftarkul_lines();
 //BA.debugLineNum = 81;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 82;BA.debugLine="b.isiKUL1 = m.Get(\"id\")";
_b.isiKUL1 = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 83;BA.debugLine="b.isiKUL2 = m.Get(\"name\")";
_b.isiKUL2 = BA.ObjectToString(_m.Get((Object)("name")));
 //BA.debugLineNum = 84;BA.debugLine="b.isiKUL3 = m.Get(\"latitude\")";
_b.isiKUL3 = BA.ObjectToString(_m.Get((Object)("latitude")));
 //BA.debugLineNum = 85;BA.debugLine="b.isiKUL4 = m.Get(\"longitude\")";
_b.isiKUL4 = BA.ObjectToString(_m.Get((Object)("longitude")));
 //BA.debugLineNum = 86;BA.debugLine="ListView1.AddSingleLine2(b.isiKUL2,b)";
...
b4a.example.kul_tem._daftarkul_lines _b = null;
 ...
 //BA.debugLineNum = 93;BA.debugLine="Dim b As daftarkul_lines";
_b = new b4a.example.kul_tem._daftarkul_lines();
 //BA.debugLineNum = 94;BA.debugLine="b=Value";
_b = (b4a.example.kul_tem._daftarkul_lines)(_value);
 //BA.debugLineNum = 95;BA.debugLine="id=b.isiKUL1";
_id = _b.isiKUL1;
 //BA.debugLineNum = 96;BA.debugLine="name=b.isiKUL2";
_name = _b.isiKUL2;
 //BA.debugLineNum = 98;BA.debugLine="StartActivity(\"detail_wis\")";
...
_inputnama11 = "inputnama11";
 //BA.debugLineNum = 10;BA.debugLine="Private wis_nama = \"wis_nama\" As String";
_wis_nama = "wis_nama";
