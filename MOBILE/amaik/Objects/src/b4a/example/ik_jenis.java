...
public class ik_jenis extends Activity implements B4AActivity{
	public static ik_jenis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.ik_jenis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ik_jenis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.ik_jenis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.ik_jenis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ik_jenis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ik_jenis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ik_jenis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _jenisikk_lines{
...
_job._initialize(processBA,_jobname,ik_jenis.getObject());
...
b4a.example.ik_jenis._jenisikk_lines _b = null;
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenisik_array.Get(_i)));
 //BA.debugLineNum = 89;BA.debugLine="Dim b As jenisikk_lines";
_b = new b4a.example.ik_jenis._jenisikk_lines();
...
b4a.example.ik_jenis._jenisikk_lines _b = null;
 ...
 //BA.debugLineNum = 131;BA.debugLine="Dim b As jenisikk_lines";
_b = new b4a.example.ik_jenis._jenisikk_lines();
 //BA.debugLineNum = 132;BA.debugLine="b=Value";
_b = (b4a.example.ik_jenis._jenisikk_lines)(_value);
...
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Type jenisikk_lines (isi1 As String,isi2 As Strin";
;
