...
public class ik_nama extends Activity implements B4AActivity{
	public static ik_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.ik_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ik_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.ik_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.ik_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ik_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ik_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ik_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _daftarik_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="Activity.LoadLayout(\"ik_nama\")";
mostCurrent._activity.LoadLayout("ik_nama",mostCurrent.activityBA);
...
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 37;BA.debugLine="EditText1.Color=Colors.RGB(167, 115, 93)";
...
anywheresoftware.b4a.keywords.Common.Log(_inputnama1);
 //BA.debugLineNum = 102;BA.debugLine="iknama1";
_iknama1();
...
_job._initialize(processBA,_jobname,ik_nama.getObject());
...
public static String  _iknama1() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub iknama1";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading...");
 //BA.debugLineNum = 51;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct id, nama_indu";
_executeremotequery("SELECT distinct id, nama_industri,alamat, cp, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from industri_kecil_region where lower(nama_industri) like lower('%"+_inputnama1+"%')","ik_nama");
...
switch (BA.switchObjectToInt(_job._jobname,_ik_nama)) {
case 0:
...
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_ik_nama_array.Get(_i)));
 //BA.debugLineNum = 76;BA.debugLine="Dim b As daftarik_lines";
_b = new b4a.example.ik_nama._daftarik_lines();
 //BA.debugLineNum = 77;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 78;BA.debugLine="b.isiIK1 = m.Get(\"id\")";
_b.isiIK1 = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 79;BA.debugLine="b.isiIK2 = m.Get(\"nama_industri\")";
_b.isiIK2 = BA.ObjectToString(_m.Get((Object)("nama_industri")));
...
_id = _b.isiIK1;
 //BA.debugLineNum = 92;BA.debugLine="nama_industri=b.isiIK2";
_nama_industri = _b.isiIK2;
 //BA.debugLineNum = 95;BA.debugLine="StartActivity(\"detailIK\")";
...
_inputnama1 = "inputnama1";
 //BA.debugLineNum = 10;BA.debugLine="Private ik_nama = \"ik_nama\" As String";
_ik_nama = "ik_nama";
 //BA.debugLineNum = 11;BA.debugLine="Dim produk, nama_industri, cp, alamat, id, latitu";
_produk = "";
_nama_industri = "";
_cp = "";
_alamat = "";
...
_latitude = "";
_longitude = "";
 //BA.debugLineNum = 12;BA.debugLine="Type daftarik_lines (isiIK1 As String,isiIK2 As S";
;
