...
public class mes_nama extends Activity implements B4AActivity{
	public static mes_nama mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.mes_nama");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mes_nama).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.mes_nama");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.mes_nama", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mes_nama) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mes_nama) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mes_nama) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _mes_nama = "";
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"mes_nama\")";
mostCurrent._activity.LoadLayout("mes_nama",mostCurrent.activityBA);
...
public static String  _edittext1_enterpressed() throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub EditText1_EnterPressed";
 //BA.debugLineNum = 101;BA.debugLine="inputnama11 = EditText1.Text";
_inputnama11 = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 102;BA.debugLine="Log(inputnama11)";
anywheresoftware.b4a.keywords.Common.Log(_inputnama11);
 //BA.debugLineNum = 103;BA.debugLine="WebView1.Visible=True";
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 105;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 106;BA.debugLine="Label1.Visible=False";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 107;BA.debugLine="Label2.Visible=True";
mostCurrent._label2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 108;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"mes_nama.php?car";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"mes_nama.php?cari_nama="+mostCurrent._edittext1.getText());
 //BA.debugLineNum = 109;BA.debugLine="iknama1";
_iknama1();
...
_job._initialize(processBA,_jobname,mes_nama.getObject());
...
_executeremotequery("SELECT distinct id, name,address, capacity, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from mosque where lower(name) like lower('%"+_inputnama11+"%')","mes_nama");
...
switch (BA.switchObjectToInt(_job._jobname,_mes_nama)) {
case 0:
...
{
final int step50 = 1;
final int limit50 = (int) (_umkm_nama_array.getSize()-1);
...
_name = _b.isiKUL2;
 //BA.debugLineNum = 97;BA.debugLine="StartActivity(\"detail_mes\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("detail_mes"));
...
_inputnama11 = "inputnama11";
 //BA.debugLineNum = 10;BA.debugLine="Private mes_nama = \"mes_nama\" As String";
_mes_nama = "mes_nama";
