...
public class search_cul extends Activity implements B4AActivity{
	public static search_cul mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.search_cul");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (search_cul).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.search_cul");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.search_cul", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (search_cul) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (search_cul) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (search_cul) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"search_cul\")";
mostCurrent._activity.LoadLayout("search_cul",mostCurrent.activityBA);
...
mostCurrent._listview1.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 29;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Nama Tempat";
mostCurrent._listview1.AddSingleLine("Berdasarkan Nama Tempat Kuliner");
 //BA.debugLineNum = 30;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Kecamatan\")";
mostCurrent._listview1.AddSingleLine("Berdasarkan Kecamatan");
 //BA.debugLineNum = 31;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Nama Kuliner";
mostCurrent._listview1.AddSingleLine("Berdasarkan Nama Kuliner");
 //BA.debugLineNum = 32;BA.debugLine="ListView1.AddSingleLine(\"Berdasarkan Fasilitas\")";
mostCurrent._listview1.AddSingleLine("Berdasarkan Fasilitas");
 //BA.debugLineNum = 34;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=14";
...
mostCurrent._listview1.getSingleLineLayout().Label.setLeft(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA));
 //BA.debugLineNum = 37;BA.debugLine="ListView1.Visible=False";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 72;BA.debugLine="If (ListView1.Visible=False) Then";
if ((mostCurrent._listview1.getVisible()==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 73;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 74;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 76;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 77;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
...
String _menu = "";
 ...
 //BA.debugLineNum = 50;BA.debugLine="Dim menu = Value As String";
_menu = BA.ObjectToString(_value);
 //BA.debugLineNum = 51;BA.debugLine="Select menu";
switch (BA.switchObjectToInt(_menu,"Berdasarkan Kecamatan","Berdasarkan Nama Tempat Kuliner","Berdasarkan Nama Kuliner","Berdasarkan Fasilitas")) {
case 0:
 //BA.debugLineNum = 53;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(\"kul_kec\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("kul_kec"));
 //BA.debugLineNum = 55;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 1:
 //BA.debugLineNum = 57;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 58;BA.debugLine="StartActivity(\"kul_tem\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("kul_tem"));
 //BA.debugLineNum = 59;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 2:
 //BA.debugLineNum = 61;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(\"kul_nama\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("kul_nama"));
 //BA.debugLineNum = 63;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
case 3:
 //BA.debugLineNum = 65;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 66;BA.debugLine="StartActivity(\"kul_fasilitas\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("kul_fasilitas"));
 //BA.debugLineNum = 67;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 break;
}
;
