...
public class detail_umkm extends Activity implements B4AActivity{
	public static detail_umkm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detail_umkm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detail_umkm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detail_umkm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detail_umkm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detail_umkm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detail_umkm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detail_umkm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 38;BA.debugLine="If  umkm_nama.id<>\"\" Then";
if ((mostCurrent._umkm_nama._id).equals("") == false) { 
 //BA.debugLineNum = 39;BA.debugLine="id_kul2=umkm_nama.id";
mostCurrent._id_kul2 = mostCurrent._umkm_nama._id;
 //BA.debugLineNum = 40;BA.debugLine="Log(\"nama umkm\")";
anywheresoftware.b4a.keywords.Common.Log("nama umkm");
 //BA.debugLineNum = 41;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._umkm_product._id).equals("") == false) { 
 //BA.debugLineNum = 43;BA.debugLine="id_kul2=umkm_product.id";
mostCurrent._id_kul2 = mostCurrent._umkm_product._id;
 //BA.debugLineNum = 44;BA.debugLine="Log(\"product umkm\")";
anywheresoftware.b4a.keywords.Common.Log("product umkm");
 }else if((mostCurrent._umkm_tipe._id).equals("") == false) { 
 //BA.debugLineNum = 46;BA.debugLine="id_kul2=umkm_tipe.id";
mostCurrent._id_kul2 = mostCurrent._umkm_tipe._id;
 //BA.debugLineNum = 47;BA.debugLine="Log(\"tipe umkm\")";
anywheresoftware.b4a.keywords.Common.Log("tipe umkm");
 };
 };
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"detailinfoumkm\")";
mostCurrent._activity.LoadLayout("detailinfoumkm",mostCurrent.activityBA);
 //BA.debugLineNum = 52;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 53;BA.debugLine="If  umkm_nama.id<>\"\" Then";
if ((mostCurrent._umkm_nama._id).equals("") == false) { 
 //BA.debugLineNum = 54;BA.debugLine="id_kul2=umkm_nama.id";
mostCurrent._id_kul2 = mostCurrent._umkm_nama._id;
 //BA.debugLineNum = 55;BA.debugLine="Log(\"nama umkm\")";
anywheresoftware.b4a.keywords.Common.Log("nama umkm");
 //BA.debugLineNum = 56;BA.debugLine="Log(id_kul2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_kul2);
 }else if((mostCurrent._umkm_product._id).equals("") == false) { 
 //BA.debugLineNum = 58;BA.debugLine="id_kul2=umkm_product.id";
mostCurrent._id_kul2 = mostCurrent._umkm_product._id;
 //BA.debugLineNum = 59;BA.debugLine="Log(\"product umkm\")";
anywheresoftware.b4a.keywords.Common.Log("product umkm");
 }else if((mostCurrent._kul_nama._id).equals("") == false) { 
 //BA.debugLineNum = 61;BA.debugLine="id_kul2=kul_nama.id";
mostCurrent._id_kul2 = mostCurrent._kul_nama._id;
 //BA.debugLineNum = 62;BA.debugLine="Log(\"nama kul\")";
anywheresoftware.b4a.keywords.Common.Log("nama kul");
 }else if((mostCurrent._radius._id).equals("") == false) { 
 //BA.debugLineNum = 64;BA.debugLine="id_kul2=radius.id";
mostCurrent._id_kul2 = mostCurrent._radius._id;
 //BA.debugLineNum = 65;BA.debugLine="Log(\"rad kul\")";
anywheresoftware.b4a.keywords.Common.Log("rad kul");
 };
 //BA.debugLineNum = 68;BA.debugLine="kul_tem.id=\"\"";
mostCurrent._kul_tem._id = "";
 //BA.debugLineNum = 69;BA.debugLine="kul_kec.id=\"\"";
mostCurrent._kul_kec._id = "";
 //BA.debugLineNum = 70;BA.debugLine="kul_nama.id=\"\"";
mostCurrent._kul_nama._id = "";
 //BA.debugLineNum = 71;BA.debugLine="radius.id=\"\"";
mostCurrent._radius._id = "";
 //BA.debugLineNum = 72;BA.debugLine="detailKUL2";
_detailkul2();
...
public static String  _bgalery_click() throws Exception{
 //BA.debugLineNum = 133;BA.debugLine="Sub bGalery_Click 'activity menuju galeri ik";
 //BA.debugLineNum = 134;BA.debugLine="StartActivity(galeri)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._galeri.getObject()));
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 139;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(galeri)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._galeri.getObject()));
 //BA.debugLineNum = 141;BA.debugLine="End Sub";
return "";
}
public static String  _detailkul2() throws Exception{
 //BA.debugLineNum = 89;BA.debugLine="Sub detailKUL2";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 91;BA.debugLine="ExecuteRemoteQuery(\"Select id, name, address, cp,";
_executeremotequery("Select id, name, address, cp, owner, st_x(st_centroid(geom)), st_y(st_centroid(geom)) from umkm where umkm.id='"+mostCurrent._id_kul2+"'","UMKM");
...
_job._initialize(processBA,_jobname,detail_umkm.getObject());
...
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Dim id_kul2 As String";
...
switch (BA.switchObjectToInt(_job._jobname,_umkm)) {
case 0:
 //BA.debugLineNum = 104;BA.debugLine="Dim umkm_array As List";
_umkm_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 105;BA.debugLine="umkm_array = parser.NextArray";
_umkm_array = _parser.NextArray();
 //BA.debugLineNum = 106;BA.debugLine="If (umkm_array.Size>0) Then";
if ((_umkm_array.getSize()>0)) { 
 //BA.debugLineNum = 107;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 109;BA.debugLine="m= umkm_array.Get(0)";
...
_id = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 111;BA.debugLine="Label2.Text=m.Get(\"name\")";
mostCurrent._label2.setText(_m.Get((Object)("name")));
 //BA.debugLineNum = 112;BA.debugLine="Label3.Text=m.Get(\"address\")";
mostCurrent._label3.setText(_m.Get((Object)("address")));
 //BA.debugLineNum = 113;BA.debugLine="Label4.Text=m.Get(\"cp\")";
mostCurrent._label4.setText(_m.Get((Object)("cp")));
 //BA.debugLineNum = 114;BA.debugLine="Label5.Text=m.Get(\"owner\")";
mostCurrent._label5.setText(_m.Get((Object)("owner")));
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private UMKM=\"UMKM\" As String";
_umkm = "UMKM";
