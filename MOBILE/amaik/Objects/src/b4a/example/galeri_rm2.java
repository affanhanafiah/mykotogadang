...
public class galeri_rm2 extends Activity implements B4AActivity{
	public static galeri_rm2 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.galeri_rm2");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (galeri_rm2).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.galeri_rm2");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.galeri_rm2", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (galeri_rm2) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (galeri_rm2) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (galeri_rm2) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("galeri",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="id=detail_rm.id";
_id = mostCurrent._detail_rm._id;
 //BA.debugLineNum = 29;BA.debugLine="detail_rm.id=\"\"";
...
_job._initialize(processBA,_jobname,galeri_rm2.getObject());
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading");
 //BA.debugLineNum = 37;BA.debugLine="ExecuteRemoteQuery(\"select distinct id_culinary,";
...
anywheresoftware.b4a.keywords.Common.Log("haha");
 //BA.debugLineNum = 70;BA.debugLine="Dim image = w.Get(\"gallery_culinary\") As Stri";
