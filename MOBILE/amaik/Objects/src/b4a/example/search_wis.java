...
public class search_wis extends Activity implements B4AActivity{
	public static search_wis mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.search_wis");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (search_wis).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.search_wis");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.search_wis", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (search_wis) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (search_wis) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (search_wis) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"search_wis\")";
mostCurrent._activity.LoadLayout("search_wis",mostCurrent.activityBA);
...
mostCurrent._listview1.AddSingleLine("Based On Name");
 //BA.debugLineNum = 30;BA.debugLine="ListView1.AddSingleLine(\"Based On Facility\")";
mostCurrent._listview1.AddSingleLine("Based On Facility");
 //BA.debugLineNum = 31;BA.debugLine="ListView1.AddSingleLine(\"Based On Radius\")";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Sub ImageView1_Click";
...
switch (BA.switchObjectToInt(_menu,"Based On Name","Based On Radius","Based On Facility")) {
case 0:
 //BA.debugLineNum = 53;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(\"wis_nama\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("wis_nama"));
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 58;BA.debugLine="StartActivity(\"radius_wis\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("radius_wis"));
...
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(\"wis_fas\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("wis_fas"));
