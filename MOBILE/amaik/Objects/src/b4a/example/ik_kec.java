...
public class ik_kec extends Activity implements B4AActivity{
	public static ik_kec mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.ik_kec");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ik_kec).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.ik_kec");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.ik_kec", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ik_kec) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ik_kec) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ik_kec) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _jeniskec_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"ik_kec\")";
mostCurrent._activity.LoadLayout("ik_kec",mostCurrent.activityBA);
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 127;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct a.id, a.nama_";
_executeremotequery("SELECT distinct a.id, a.nama_industri, a.alamat, a.cp, ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude from industri_kecil_region as a, kecamatan WHERE st_contains(kecamatan.geom, a.geom) and kecamatan.id_kecamatan='"+_idikec+"' order by nama_industri asc","KECIK1");
 //BA.debugLineNum = 128;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 65;BA.debugLine="Spinner1.Add(\"--Pilih Kecamatan--\")";
mostCurrent._spinner1.Add("--Pilih Kecamatan--");
 //BA.debugLineNum = 66;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 67;BA.debugLine="ExecuteRemoteQuery(\"select * from kecamatan\",\"KEC";
...
anywheresoftware.b4a.samples.httputils2.httpjob _job = null;
 //BA.debugLineNum = 58;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 59;BA.debugLine="Dim Job As HttpJob";
_job = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 60;BA.debugLine="Job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,ik_kec.getObject());
 //BA.debugLineNum = 61;BA.debugLine="Job.PostString(\"\"&Main.Server&\"json.php\", Query)";
...
b4a.example.ik_kec._jeniskec_lines _b = null;
...
case 0:
 //BA.debugLineNum = 80;BA.debugLine="Dim kecik_array As List";
_kecik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 81;BA.debugLine="kecik_array = parser.NextArray";
_kecik_array = _parser.NextArray();
 //BA.debugLineNum = 82;BA.debugLine="If kecik_array.Size - 1 < 0 Then";
if (_kecik_array.getSize()-1<0) { 
 //BA.debugLineNum = 83;BA.debugLine="Msgbox(\"Industri kecil tidak ditemukan\", \"Peri";
anywheresoftware.b4a.keywords.Common.Msgbox("Industri kecil tidak ditemukan","Peringatan",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 85;BA.debugLine="For i=0 To kecik_array.Size -1";
{
final int step58 = 1;
final int limit58 = (int) (_kecik_array.getSize()-1);
for (_i = (int) (0); (step58 > 0 && _i <= limit58) || (step58 < 0 && _i >= limit58); _i = ((int)(0 + _i + step58))) {
 //BA.debugLineNum = 86;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 87;BA.debugLine="a = kecik_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_kecik_array.Get(_i)));
 //BA.debugLineNum = 88;BA.debugLine="Dim b As jeniskec_lines";
_b = new b4a.example.ik_kec._jeniskec_lines();
 //BA.debugLineNum = 89;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 90;BA.debugLine="b.isi1 = a.Get(\"id\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 91;BA.debugLine="b.isi2 = a.Get(\"nama_industri\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("nama_industri")));
 //BA.debugLineNum = 92;BA.debugLine="b.isi3 = a.Get(\"alamat\")";
_b.isi3 = BA.ObjectToString(_a.Get((Object)("alamat")));
 //BA.debugLineNum = 93;BA.debugLine="b.isi4 = a.Get(\"cp\")";
_b.isi4 = BA.ObjectToString(_a.Get((Object)("cp")));
 //BA.debugLineNum = 94;BA.debugLine="ListView1.AddSingleLine2(b.isi2,b) 'meletakka";
mostCurrent._listview1.AddSingleLine2(_b.isi2,(Object)(_b));
 ...
 break;
case 1:
 //BA.debugLineNum = 99;BA.debugLine="Dim jenis_array As List";
_jenis_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 100;BA.debugLine="jenis_daftar.Initialize";
_jenis_daftar.Initialize();
 //BA.debugLineNum = 101;BA.debugLine="jenis_array = parser.NextArray";
_jenis_array = _parser.NextArray();
 //BA.debugLineNum = 102;BA.debugLine="If(jenis_array.Size>0) Then";
if ((_jenis_array.getSize()>0)) { 
 //BA.debugLineNum = 103;BA.debugLine="For i=0 To jenis_array.Size -1";
{
final int step75 = 1;
final int limit75 = (int) (_jenis_array.getSize()-1);
for (_i = (int) (0); (step75 > 0 && _i <= limit75) || (step75 < 0 && _i >= limit75); _i = ((int)(0 + _i + step75))) {
 //BA.debugLineNum = 104;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 105;BA.debugLine="a = jenis_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 106;BA.debugLine="id_kecamatan=a.Get(\"id_kecamatan\")";
_id_kecamatan = BA.ObjectToString(_a.Get((Object)("id_kecamatan")));
 //BA.debugLineNum = 107;BA.debugLine="nama_kecamatan=a.Get(\"nama_kecamatan\")";
_nama_kecamatan = BA.ObjectToString(_a.Get((Object)("nama_kecamatan")));
 //BA.debugLineNum = 108;BA.debugLine="Spinner1.Add(nama_kecamatan)";
mostCurrent._spinner1.Add(_nama_kecamatan);
 //BA.debugLineNum = 109;BA.debugLine="jenis_daftar.Put(nama_kecamatan, id_kecamatan";
...
b4a.example.ik_kec._jeniskec_lines _b = null;
 //BA.debugLineNum = 130;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 132;BA.debugLine="Dim b As jeniskec_lines";
_b = new b4a.example.ik_kec._jeniskec_lines();
 //BA.debugLineNum = 133;BA.debugLine="b=Value";
_b = (b4a.example.ik_kec._jeniskec_lines)(_value);
 //BA.debugLineNum = 134;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 135;BA.debugLine="nama_industri=b.isi2";
_nama_industri = _b.isi2;
 //BA.debugLineNum = 136;BA.debugLine="StartActivity(\"detailIK\")";
...
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 12;BA.debugLine="Type jeniskec_lines (isi1 As String,isi2 As Strin";
;
 //BA.debugLineNum = 13;BA.debugLine="Dim id_kecamatan As String";
_id_kecamatan = "";
 //BA.debugLineNum = 14;BA.debugLine="Dim nama_kecamatan As String";
_nama_kecamatan = "";
 //BA.debugLineNum = 15;BA.debugLine="Dim id, idikec As String";
_id = "";
_idikec = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim nama_industri As String";
_nama_industri = "";
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 119;BA.debugLine="idikec= jenis_daftar.Get(Value) 'mengambil jenis";
