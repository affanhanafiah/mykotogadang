...
public class galerirm extends Activity implements B4AActivity{
	public static galerirm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.galerirm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (galerirm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.galerirm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.galerirm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (galerirm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (galerirm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (galerirm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"galeri\")";
mostCurrent._activity.LoadLayout("galeri",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="id=detail_rm.id";
_id = mostCurrent._detail_rm._id;
 //BA.debugLineNum = 28;BA.debugLine="detail_rm.id=\"\"";
mostCurrent._detail_rm._id = "";
 //BA.debugLineNum = 30;BA.debugLine="fotoquery";
_fotoquery();
...
anywheresoftware.b4a.samples.httputils2.httpjob _job = null;
 //BA.debugLineNum = 39;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 40;BA.debugLine="Dim Job As HttpJob";
_job = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 41;BA.debugLine="Job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,galerirm.getObject());
 //BA.debugLineNum = 42;BA.debugLine="Job.PostString(\"\"&Main.server&\"json.php\", Query)";
_job._poststring(""+mostCurrent._main._server+"json.php",_query);
 //BA.debugLineNum = 43;BA.debugLine="End Sub";
return "";
}
public static String  _fotoquery() throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub fotoquery";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading");
 //BA.debugLineNum = 36;BA.debugLine="ExecuteRemoteQuery(\"select distinct id_culinary,";
_executeremotequery("select distinct id_culinary, gallery_culinary from culinary_gallery where id_culinary='"+_id+"'","ViewFoto");
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private ImageView2 As ImageView";
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private ImageView3 As ImageView";
...
if (_job._success) { 
 //BA.debugLineNum = 49;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 50;BA.debugLine="res= Job.GetString";
_res = _job._getstring();
 //BA.debugLineNum = 51;BA.debugLine="Log (\"Respon from server:\" & res)";
...
case 0:
 //BA.debugLineNum = 57;BA.debugLine="Dim agn As List";
_agn = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 58;BA.debugLine="agn=parser.NextArray";
_agn = _parser.NextArray();
 //BA.debugLineNum = 59;BA.debugLine="If agn.Size - 1 < 0 Then";
if (_agn.getSize()-1<0) { 
 //BA.debugLineNum = 60;BA.debugLine="Log(agn.Size)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_agn.getSize()));
 //BA.debugLineNum = 61;BA.debugLine="Msgbox(\"Gallery Photos Not Found\", \"Peringatan";
anywheresoftware.b4a.keywords.Common.Msgbox("Gallery Photos Not Found","Peringatan",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 63;BA.debugLine="Dim serverimage = \"http://192.168.1.2/kotogada";
_serverimage = "http://192.168.1.2/kotogadang/";
 //BA.debugLineNum = 64;BA.debugLine="For i=0 To agn.Size-1";
{
final int step42 = 1;
final int limit42 = (int) (_agn.getSize()-1);
for (_i = (int) (0); (step42 > 0 && _i <= limit42) || (step42 < 0 && _i >= limit42); _i = ((int)(0 + _i + step42))) {
 //BA.debugLineNum = 65;BA.debugLine="Dim w As Map";
_w = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 66;BA.debugLine="w=agn.Get(i)";
_w.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_agn.Get(_i)));
 //BA.debugLineNum = 67;BA.debugLine="Log(\"haha\")";
anywheresoftware.b4a.keywords.Common.Log("haha");
 //BA.debugLineNum = 68;BA.debugLine="Dim image = w.Get(\"gallery_culinary\") As Stri";
_image = BA.ObjectToString(_w.Get((Object)("gallery_culinary")));
 //BA.debugLineNum = 70;BA.debugLine="Dim gambar = \"\"&serverimage&\"\"&image As Strin";
_gambar = ""+_serverimage+""+_image;
 //BA.debugLineNum = 71;BA.debugLine="If i=0 Then";
if (_i==0) { 
 //BA.debugLineNum = 72;BA.debugLine="Dim link As Map";
_link = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 73;BA.debugLine="link.Initialize";
_link.Initialize();
 //BA.debugLineNum = 75;BA.debugLine="link.Put(ImageView1,gambar)";
_link.Put((Object)(mostCurrent._imageview1.getObject()),(Object)(_gambar));
 //BA.debugLineNum = 76;BA.debugLine="CallSubDelayed2(imageDownloader, \"Download\",";
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._imagedownloader.getObject()),"Download",(Object)(_link));
 ...
 //BA.debugLineNum = 78;BA.debugLine="Dim link As Map";
_link = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 79;BA.debugLine="link.Initialize";
_link.Initialize();
 //BA.debugLineNum = 81;BA.debugLine="link.Put(ImageView2,gambar)";
_link.Put((Object)(mostCurrent._imageview2.getObject()),(Object)(_gambar));
 //BA.debugLineNum = 82;BA.debugLine="CallSubDelayed2(imageDownloader, \"Download\",";
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._imagedownloader.getObject()),"Download",(Object)(_link));
 }else if(_i==2) { 
 //BA.debugLineNum = 84;BA.debugLine="Dim link As Map";
_link = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 85;BA.debugLine="link.Initialize";
_link.Initialize();
 //BA.debugLineNum = 87;BA.debugLine="link.Put(ImageView3,gambar)";
_link.Put((Object)(mostCurrent._imageview3.getObject()),(Object)(_gambar));
 //BA.debugLineNum = 88;BA.debugLine="CallSubDelayed2(imageDownloader, \"Download\",";
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._imagedownloader.getObject()),"Download",(Object)(_link));
 };
 }
};
