...
public class umkm_tipe extends Activity implements B4AActivity{
	public static umkm_tipe mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.umkm_tipe");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (umkm_tipe).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.umkm_tipe");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.umkm_tipe", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (umkm_tipe) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (umkm_tipe) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (umkm_tipe) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static class _tipeumkm_lines{
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 40;BA.debugLine="Activity.LoadLayout(\"umkm_tipe\")";
mostCurrent._activity.LoadLayout("umkm_tipe",mostCurrent.activityBA);
 //BA.debugLineNum = 41;BA.debugLine="WebView1.Visible=False";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 42;BA.debugLine="Panel1.Visible=False";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 43;BA.debugLine="daftarjenis";
_daftarjenis();
 //BA.debugLineNum = 45;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor=Colors";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (72),(int) (39),(int) (39)));
 //BA.debugLineNum = 46;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize=16";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 48;BA.debugLine="Spinner1.DropdownBackgroundColor=Colors.RGB(255,";
mostCurrent._spinner1.setDropdownBackgroundColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 50;BA.debugLine="ListView1.SingleLineLayout.Label.Left=2%y";
...
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 127;BA.debugLine="Panel2.Visible=False";
...
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 129;BA.debugLine="ExecuteRemoteQuery(\"SELECT distinct a.id, a.name,";
_executeremotequery("SELECT distinct a.id, a.name, a.address, a.cp, ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude from umkm as a, umkm_type WHERE a.id_type=umkm_type.id_type and umkm_type.id_type='"+_idkulkec+"' order by a.name asc","KECKUL11");
 //BA.debugLineNum = 130;BA.debugLine="WebView1.Visible=True";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 131;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"tipe_umkm.php?ca";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"tipe_umkm.php?cari_nama="+_idkulkec);
 //BA.debugLineNum = 132;BA.debugLine="End Sub";
return "";
}
public static String  _daftarjenis() throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Sub daftarjenis";
 //BA.debugLineNum = 69;BA.debugLine="Spinner1.Add(\"--Choose Product Type--\")";
mostCurrent._spinner1.Add("--Choose Product Type--");
 //BA.debugLineNum = 70;BA.debugLine="ProgressDialogShow(\"Loading ....\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 71;BA.debugLine="ExecuteRemoteQuery(\"select * from umkm_type\",\"KEC";
_executeremotequery("select * from umkm_type","KEC11");
...
_job._initialize(processBA,_jobname,umkm_tipe.getObject());
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private WebView1 As WebView";
...
b4a.example.umkm_tipe._tipeumkm_lines _b = null;
...
_res = _job._getstring();
 //BA.debugLineNum = 79;BA.debugLine="Log(\"Response from server :\"& res)";
...
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 81;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 //BA.debugLineNum = 82;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname,_keckul11,_kec11)) {
case 0:
 //BA.debugLineNum = 84;BA.debugLine="Dim kecik_array As List";
_kecik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 85;BA.debugLine="kecik_array = parser.NextArray";
_kecik_array = _parser.NextArray();
 //BA.debugLineNum = 86;BA.debugLine="If kecik_array.Size - 1 < 0 Then";
if (_kecik_array.getSize()-1<0) { 
 //BA.debugLineNum = 87;BA.debugLine="Msgbox(\"Tidak ditemukan\", \"Peringatan\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Tidak ditemukan","Peringatan",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 89;BA.debugLine="For i=0 To kecik_array.Size -1";
{
final int step62 = 1;
final int limit62 = (int) (_kecik_array.getSize()-1);
...
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 91;BA.debugLine="a = kecik_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_kecik_array.Get(_i)));
 //BA.debugLineNum = 92;BA.debugLine="Dim b As tipeumkm_lines";
_b = new b4a.example.umkm_tipe._tipeumkm_lines();
 //BA.debugLineNum = 93;BA.debugLine="b.Initialize";
_b.Initialize();
 //BA.debugLineNum = 94;BA.debugLine="b.isi1 = a.Get(\"id\")";
_b.isi1 = BA.ObjectToString(_a.Get((Object)("id")));
 //BA.debugLineNum = 95;BA.debugLine="b.isi2 = a.Get(\"name\")";
_b.isi2 = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 96;BA.debugLine="ListView1.AddSingleLine2(b.isi2,b) 'meletakka";
...
_jenis_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 102;BA.debugLine="jenis_daftar.Initialize";
...
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_jenis_array.Get(_i)));
 //BA.debugLineNum = 108;BA.debugLine="id=a.Get(\"id_type\")";
_id = BA.ObjectToString(_a.Get((Object)("id_type")));
 //BA.debugLineNum = 109;BA.debugLine="name=a.Get(\"name\")";
_name = BA.ObjectToString(_a.Get((Object)("name")));
 //BA.debugLineNum = 110;BA.debugLine="Spinner1.Add(name)";
mostCurrent._spinner1.Add(_name);
 //BA.debugLineNum = 111;BA.debugLine="jenis_daftar.Put(name, id)";
...
b4a.example.umkm_tipe._tipeumkm_lines _b = null;
 //BA.debugLineNum = 134;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 136;BA.debugLine="Dim b As tipeumkm_lines";
_b = new b4a.example.umkm_tipe._tipeumkm_lines();
 //BA.debugLineNum = 137;BA.debugLine="b=Value";
_b = (b4a.example.umkm_tipe._tipeumkm_lines)(_value);
 //BA.debugLineNum = 138;BA.debugLine="id=b.isi1";
_id = _b.isi1;
 //BA.debugLineNum = 139;BA.debugLine="name=b.isi2";
_name = _b.isi2;
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(\"detail_umkm\")";
...
_jenis_daftar = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 15;BA.debugLine="Type tipeumkm_lines (isi1 As String,isi2 As Strin";
;
...
public static String  _spinner1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 121;BA.debugLine="idkulkec= jenis_daftar.Get(Value) 'mengambil jeni";
