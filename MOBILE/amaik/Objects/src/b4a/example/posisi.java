...
public class posisi extends Activity implements B4AActivity{
	public static posisi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.posisi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (posisi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.posisi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.posisi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (posisi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (posisi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (posisi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static float _latuser = 0f;
public static float _lnguser = 0f;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"posisi\")";
mostCurrent._activity.LoadLayout("posisi",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="latUser=0";
_latuser = (float) (0);
 //BA.debugLineNum = 29;BA.debugLine="lngUser=0";
_lnguser = (float) (0);
 //BA.debugLineNum = 30;BA.debugLine="gpsClient.Initialize(\"gpsClient\")";
_gpsclient.Initialize("gpsClient");
 //BA.debugLineNum = 31;BA.debugLine="userLocation.Initialize";
_userlocation.Initialize();
 //BA.debugLineNum = 32;BA.debugLine="posisi1";
_posisi1();
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="gpsClient.Stop";
_gpsclient.Stop();
...
public static String  _cekgps() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub cekGPS 'melakukan mengecekan GPS pada pengguna";
 //BA.debugLineNum = 40;BA.debugLine="If (latUser=0 And lngUser=0) Then";
if ((_latuser==0 && _lnguser==0)) { 
 //BA.debugLineNum = 41;BA.debugLine="If gpsClient.GPSEnabled=False Then";
if (_gpsclient.getGPSEnabled()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 42;BA.debugLine="ToastMessageShow(\"Aktifkan GPS\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Aktifkan GPS",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 43;BA.debugLine="StartActivity(gpsClient.LocationSettingsIntent)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_gpsclient.getLocationSettingsIntent()));
 }else {
 //BA.debugLineNum = 45;BA.debugLine="gpsClient.Start(0,0)";
_gpsclient.Start(processBA,(long) (0),(float) (0));
 //BA.debugLineNum = 46;BA.debugLine="ProgressDialogShow(\"Tunggu Lokasi\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Tunggu Lokasi");
 };
 }else {
 //BA.debugLineNum = 49;BA.debugLine="petaClient";
_petaclient();
 };
...
_job._initialize(processBA,_jobname,posisi.getObject());
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub ImageView1_Click";
 //BA.debugLineNum = 78;BA.debugLine="cekGPS";
_cekgps();
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return "";
}
public static String  _petaclient() throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub petaClient";
 //BA.debugLineNum = 54;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"peta.php?lat=\"&l";
...
public static String  _posisi1() throws Exception{
 //BA.debugLineNum = 35;BA.debugLine="Sub posisi1";
 //BA.debugLineNum = 36;BA.debugLine="WebView1.LoadUrl(\"\"&Main.Server&\"peta.php\")";
mostCurrent._webview1.LoadUrl(""+mostCurrent._main._server+"peta.php");
...
_userlocation = new anywheresoftware.b4a.gps.LocationWrapper();
 //BA.debugLineNum = 11;BA.debugLine="Dim latUser, lngUser As Float";
_latuser = 0f;
_lnguser = 0f;
 //BA.debugLineNum = 12;BA.debugLine="Dim Server=\"http://192.168.1.2/kotogadang/andro/\"";
