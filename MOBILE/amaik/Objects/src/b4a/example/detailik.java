...
public class detailik extends Activity implements B4AActivity{
	public static detailik mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detailik");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detailik).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detailik");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detailik", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detailik) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detailik) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (detailik) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 37;BA.debugLine="If  ik_nama.id<>\"\" Then";
if ((mostCurrent._ik_nama._id).equals("") == false) { 
 //BA.debugLineNum = 38;BA.debugLine="id_ik2=ik_nama.id";
mostCurrent._id_ik2 = mostCurrent._ik_nama._id;
 //BA.debugLineNum = 39;BA.debugLine="Log(\"nama ik\")";
anywheresoftware.b4a.keywords.Common.Log("nama ik");
 //BA.debugLineNum = 40;BA.debugLine="Log(id_ik2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_ik2);
 }else if((mostCurrent._ik_kec._id).equals("") == false) { 
 //BA.debugLineNum = 42;BA.debugLine="id_ik2=ik_kec.id";
mostCurrent._id_ik2 = mostCurrent._ik_kec._id;
 //BA.debugLineNum = 43;BA.debugLine="Log(\"kecamatan ik\")";
anywheresoftware.b4a.keywords.Common.Log("kecamatan ik");
 }else if((mostCurrent._ik_jenis._id).equals("") == false) { 
 //BA.debugLineNum = 45;BA.debugLine="id_ik2=ik_jenis.id";
mostCurrent._id_ik2 = mostCurrent._ik_jenis._id;
 //BA.debugLineNum = 46;BA.debugLine="Log(\"tipe ik\")";
anywheresoftware.b4a.keywords.Common.Log("tipe ik");
 };
 };
 //BA.debugLineNum = 52;BA.debugLine="Activity.LoadLayout(\"detailinfoik\")";
mostCurrent._activity.LoadLayout("detailinfoik",mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="Log(id)";
anywheresoftware.b4a.keywords.Common.Log(_id);
 //BA.debugLineNum = 55;BA.debugLine="If  ik_nama.id<>\"\" Then";
if ((mostCurrent._ik_nama._id).equals("") == false) { 
 //BA.debugLineNum = 56;BA.debugLine="id_ik2=ik_nama.id";
mostCurrent._id_ik2 = mostCurrent._ik_nama._id;
 //BA.debugLineNum = 57;BA.debugLine="Log(\"nama ik\")";
anywheresoftware.b4a.keywords.Common.Log("nama ik");
 //BA.debugLineNum = 58;BA.debugLine="Log(id_ik2)";
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._id_ik2);
 }else if((mostCurrent._ik_kec._id).equals("") == false) { 
 //BA.debugLineNum = 60;BA.debugLine="id_ik2=ik_kec.id";
mostCurrent._id_ik2 = mostCurrent._ik_kec._id;
 //BA.debugLineNum = 61;BA.debugLine="Log(\"kecamatan ik\")";
anywheresoftware.b4a.keywords.Common.Log("kecamatan ik");
 }else if((mostCurrent._ik_jenis._id).equals("") == false) { 
 //BA.debugLineNum = 63;BA.debugLine="id_ik2=ik_jenis.id";
mostCurrent._id_ik2 = mostCurrent._ik_jenis._id;
 //BA.debugLineNum = 64;BA.debugLine="Log(\"tipe ik\")";
anywheresoftware.b4a.keywords.Common.Log("tipe ik");
 };
 //BA.debugLineNum = 67;BA.debugLine="ik_nama.id=\"\"";
mostCurrent._ik_nama._id = "";
 //BA.debugLineNum = 68;BA.debugLine="ik_kec.id=\"\"";
mostCurrent._ik_kec._id = "";
 //BA.debugLineNum = 69;BA.debugLine="ik_jenis.id=\"\"";
mostCurrent._ik_jenis._id = "";
 //BA.debugLineNum = 71;BA.debugLine="detailIK2";
_detailik2();
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 127;BA.debugLine="ikposisi.latTujuan=lat";
mostCurrent._ikposisi._lattujuan = _lat;
 //BA.debugLineNum = 128;BA.debugLine="ikposisi.lngTujuan=lng";
mostCurrent._ikposisi._lngtujuan = _lng;
 //BA.debugLineNum = 130;BA.debugLine="StartActivity(\"ikposisi\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("ikposisi"));
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 133;BA.debugLine="Sub Button2_Click 'activity menuju galeri ik";
 //BA.debugLineNum = 134;BA.debugLine="StartActivity(ik_gallery)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._ik_gallery.getObject()));
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public static String  _detailik2() throws Exception{
 //BA.debugLineNum = 89;BA.debugLine="Sub detailIK2";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading ....");
 //BA.debugLineNum = 91;BA.debugLine="ExecuteRemoteQuery(\"Select id, nama_industri, ala";
_executeremotequery("Select id, nama_industri, alamat, produk,harga_barang, st_x(st_centroid(geom)), st_y(st_centroid(geom)) from industri_kecil_region where industri_kecil_region.id='"+mostCurrent._id_ik2+"'","IK");
...
_job._initialize(processBA,_jobname,detailik.getObject());
 //BA.debugLineNum = 86;BA.debugLine="Job.PostString(\"\"&Main.server&\"json.php\", Query)";
...
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim id_ik2 As String";
mostCurrent._id_ik2 = "";
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return "";
}
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub ImageView4_Click  'activity menuju halaman awa";
 //BA.debugLineNum = 137;BA.debugLine="StartActivity(Main)";
...
_res = "";
 //BA.debugLineNum = 98;BA.debugLine="res = Job.GetString";
_res = _job._getstring();
 //BA.debugLineNum = 99;BA.debugLine="Log(\"Response from server :\"&res)";
...
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 101;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 //BA.debugLineNum = 102;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname,_ik)) {
case 0:
 //BA.debugLineNum = 104;BA.debugLine="Dim ik_array As List";
_ik_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 105;BA.debugLine="ik_array = parser.NextArray";
_ik_array = _parser.NextArray();
 //BA.debugLineNum = 106;BA.debugLine="If (ik_array.Size>0) Then";
if ((_ik_array.getSize()>0)) { 
 //BA.debugLineNum = 107;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 109;BA.debugLine="m= ik_array.Get(0)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_ik_array.Get((int) (0))));
 //BA.debugLineNum = 110;BA.debugLine="id=m.Get(\"id\")";
_id = BA.ObjectToString(_m.Get((Object)("id")));
 //BA.debugLineNum = 111;BA.debugLine="Label2.Text=m.Get(\"nama_industri\")";
mostCurrent._label2.setText(_m.Get((Object)("nama_industri")));
 //BA.debugLineNum = 112;BA.debugLine="Label3.Text=m.Get(\"alamat\")";
mostCurrent._label3.setText(_m.Get((Object)("alamat")));
 //BA.debugLineNum = 113;BA.debugLine="Label4.Text=m.Get(\"produk\")";
mostCurrent._label4.setText(_m.Get((Object)("produk")));
 //BA.debugLineNum = 114;BA.debugLine="Label5.Text=m.Get(\"harga_barang\")";
mostCurrent._label5.setText(_m.Get((Object)("harga_barang")));
 //BA.debugLineNum = 115;BA.debugLine="lng=m.Get(\"st_x\")";
_lng = BA.ObjectToString(_m.Get((Object)("st_x")));
 //BA.debugLineNum = 116;BA.debugLine="lat=m.Get(\"st_y\")";
_lat = BA.ObjectToString(_m.Get((Object)("st_y")));
 //BA.debugLineNum = 117;BA.debugLine="Log(Label2)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._label2));
 }else {
 //BA.debugLineNum = 119;BA.debugLine="Msgbox(\"Data Tidak Ada\",\"Info\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 10;BA.debugLine="Private IK=\"IK\" As String";
_ik = "IK";
 //BA.debugLineNum = 11;BA.debugLine="Dim id, lat, lng As String";
_id = "";
_lat = "";
_lng = "";
