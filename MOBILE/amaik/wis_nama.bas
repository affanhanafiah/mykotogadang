...
Sub Process_Globals
	...
	Private wis_nama = "wis_nama" As String
...
Sub iknama1
	...
	ExecuteRemoteQuery("SELECT distinct id, name,address, ticket,open,close,information, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from tourism where lower(name) like lower('%"&inputnama11&"%')","wis_nama")
End Sub
...
Sub EditText1_EnterPressed
	...
	Label2.Visible=True
	WebView1.LoadUrl(""&Main.Server&"wis_nama.php?cari_nama="&EditText1.Text)
	iknama1
End Sub