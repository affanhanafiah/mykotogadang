...
Sub Process_Globals
	...
	Private mes_nama = "mes_nama" As String
...
Sub iknama1
	...
	ExecuteRemoteQuery("SELECT distinct id, name,address, capacity, st_x(st_centroid(geom)) as longitude, st_y(st_centroid(geom)) As latitude from mosque where lower(name) like lower('%"&inputnama11&"%')","mes_nama")
End Sub
...
Sub EditText1_EnterPressed
	...
	Label2.Visible=True
	WebView1.LoadUrl(""&Main.Server&"mes_nama.php?cari_nama="&EditText1.Text)
	iknama1
End Sub