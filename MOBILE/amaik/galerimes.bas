...
Sub fotoquery
	...
	ExecuteRemoteQuery("select distinct id_mosque, gallery_mosque from mosque_gallery where id_mosque='"&id&"'","ViewFoto")
End Sub
...
'			ResetImagesBackground
			...
			Else
				...
				For i=0 To agn.Size-1
					...
					w=agn.Get(i)	
					Log("haha")		
					Dim image = w.Get("gallery_mosque") As String
