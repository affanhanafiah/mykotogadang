...
Sub fotoquery
	...
	ExecuteRemoteQuery("select distinct id_greatcharacter, gallery_greatcharacter from greatcharacter_gallery where id_greatcharacter='"&id&"'","ViewFoto")
End Sub
...
'			ResetImagesBackground
			...
			Else
				...
				For i=0 To agn.Size-1
					...
					w=agn.Get(i)	
					Log("haha")		
					Dim image = w.Get("gallery_greatcharacter") As String
