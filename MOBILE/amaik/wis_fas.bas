...
Sub Process_Globals
	...
	Type tipewis_lines (isi1 As String,isi2 As String,isi3 As String,isi4 As String)
...
Sub daftarjenis
	...
	Spinner1.Add("Toilet")
	Spinner1.Add("Rest Area")
	Spinner1.Add("Mushalla")
	Spinner1.Add("Canteen")
End Sub
...
Sub Button1_Click
	...
	ListView1.Clear
	ExecuteRemoteQuery("SELECT distinct a.id, a.name, a.address, ST_X(ST_Centroid(a.geom)) AS longitude, ST_Y(ST_CENTROID(a.geom)) As latitude from tourism as a WHERE a.id='"&idkulkec&"'","KECKUL11")
	WebView1.Visible=True
	WebView1.LoadUrl(""&Main.Server&"wis_nama.php?cari_nama="&nmwis)
End Sub
