...
$querysearch = "SELECT id, nama, lokasi, jam_buka, jam_tutup, biaya, fasilitas, keterangan, st_x(st_centroid(geom)) 
as lon,st_y(st_centroid(geom)) as lat from _tempat_wisata where id='$cari'";
