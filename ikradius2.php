...
// 			 "; 
	...
	// st_distance_sphere(ST_GeomFromText('POINT(".$longi." ".$latit.")'), ST_Centroid(umkm.geom)) as jarak FROM umkm 
    // where st_distance_sphere(ST_GeomFromText('POINT(".$longi." ".$latit.")'), ST_Centroid(umkm.geom)) <= ".$rad."";
