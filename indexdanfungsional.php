...
function aktifkanRadiussem()
{
  ...
  if (koordinat == 'null')
  {
    ...
    var inputradiussem = document.getElementById("inputradiussem").value;
    console.log(inputradiussem);
    var circle = new google.maps.Circle({
      center: koordinat,
      radius: parseFloat(inputradiussem*100),      
      map: map,
      strokeColor: "blue",
      strokeOpacity: 0.5,
      strokeWeight: 1,
    ...
    wisata_sekitar(koordinat.lat,koordinat.lng,parseFloat(inputradiussem*100));
    $("#hasilwisata").show();

    kuliner_sekitar(koordinat.lat,koordinat.lng,parseFloat(inputradiussem*100));
    $("#hasilculi").show();
  
    masjid_sekitar(koordinat.lat,koordinat.lng,parseFloat(inputradiussem*100));
    $("#hasilmosque").show();
  
    tokoh_sekitar(koordinat.lat,koordinat.lng,parseFloat(inputradiussem*100));
    $("#hasiltokoh").show();
  
    tw_sekitar(koordinat.lat,koordinat.lng,parseFloat(inputradiussem*100));
    $("#hasilobj").show();
  }
  cekRadiusStatus = 'on';
          //TAMPILAN
                        ...
                        <li>
                          <div class="search">
                            <div class="col-md-12 padding-0 text-center">
                              ...
                              <input type="text"  class="form-text" placeholder="   search by name.." id="cari_sem" required>
                              <span class="bar"></span> 
                              </div>         
                              <button type="submit" class="btn btn-info btn-block btn-flat" id="carisemua" onclick='find_sem();'>Show</button>
                            </div> 
                          </div> 
                        </li>
                      </div>         
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub"> 
                          <li class="sub-menu">
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <input type="text"  class="form-text" placeholder="input name" id="fungsi1nama" required>
                                                      <span class="bar"></span> 
                                                  </div>         
                                              </div> 
                                          </div>
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi1produk">
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi1jenis">
                                      <option value="">-Choose-</option>
                                      <?php
                                          include("connect.php"); 
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group" style="color: white;"> <br>
                                      <label for="fungsi1radius">Radius :</label>
                                      <label  id="fungsi1nilai">0</label> x 100m
                                      <input  type="range" id="fungsi1radius" onchange="cekfungsi1();aktifkanfungsi1();"
                                              name="fungsi1radius" data-highlight="true" min="0" max="20" value="0" >
                                      <script>
                                          function cekfungsi1()
                                          {
                                              document.getElementById('fungsi1nilai').innerHTML=document.getElementById('fungsi1radius').value
                                          }
                                      </script>
                                  </div>
                              </ul>
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      ...
                                      <button type="submit" class="btn btn-info btn-block btn-flat" id="fungsional1kirim" onclick='fungsionalsatu();'>Search</button>
                                  </div>
                              </ul>
                          </li>
                      </ul>
                      ...
                      <ul class="sub">		  
                          <li class="sub-menu">
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <input type="text"  class="form-text" placeholder="   search by name.." id="fungsi2nama" required>
                                                      <span class="bar"></span> 
                                                  </div>
                                              </div> 
                                          </div>
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi2menu">
                                                      <option value="">-Choose-</option>
                                                      <?php
                                                      include("connect.php"); 
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi2angkot">
                                                      <option value="">-Choose-</option>
                                                      <?php
                                                      include("connect.php"); 
                                                      $angkotculinary=mysqli_query($conn,"select * from angkot order by id_angkot ASC");
                                                      while($rowangkotculinary = mysqli_fetch_assoc($angkotculinary))
                                                      {
                                                          echo"<option value=".$rowangkotculinary['id_angkot'].">".$rowangkotculinary['id_angkot']."</option>";
                                                      }
                                                      ?></select>
                                                  </div>
                                              </div> 
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group" style="color: white;"> <br>
                                      <label>Based On Radius</label><br>
                                      <label for="fungsi2radius">Radius : </label>
                                      <label  id="fungsi2nilai">0</label> x 100m
                                      <script>
                                          function cekfungsi2()
                                          {
                                              document.getElementById('fungsi2nilai').innerHTML=document.getElementById('fungsi2radius').value
                                          }
                                      </script>
                                      <input  type="range" onchange="cekfungsi2();aktifkanfungsi2();" id="fungsi2radius" name="inputradiusrm" data-highlight="true" min="0" max="20" value="0" >
                                  </div>                     
                              </ul>
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <!-- <script src="fungsi2.js"></script> -->
                                      <button type="submit" class="btn btn-info btn-block btn-flat" id="fungsional2kirim" onclick='fungsionaldua();'>Search</button>
                                  </div>
                              </ul>
                          </li>		            
                      </ul>
                          ...
                          <li class="sub-menu">
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <input type="text"  class="form-text" placeholder="   search by name.." id="fungsi3nama" required>
                                                      <span class="bar"></span> 
                                                  </div>
                                              </div> 
                                          </div>
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group"> <br>
                                      ...
                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi3fas">
                                      <option value="">-Choose-</option>
                                      <?php
                                          include("connect.php"); 
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi3angkot">
                                                      <option value="">-Choose-</option>
                                                      <?php
                                                      include("connect.php"); 
                                                      $angkotculinary=mysqli_query($conn,"select * from angkot order by id_angkot ASC");
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group" style="color: white;"> <br>
                                      <label>Based On Radius</label><br>
                                      <label for="fungsi3radius">Radius : </label>
                                      <label  id="fungsi3nilai">0</label> x 100m
                                      <script>
                                      function cekwis()
                                      {
                                          document.getElementById('fungsi3nilai').innerHTML=document.getElementById('fungsi3radius').value
                                      }
                                      </script>
                                      <input  type="range" onchange="aktifkanfungsi3();" id="fungsi3radius" 
                                              name="fungsi3radius" data-highlight="true" min="0" max="20" value="0" >
                                  </div>               
                              </ul>
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <!-- <script src="fungsi2.js"></script> -->
                                      <button type="submit" class="btn btn-info btn-block btn-flat" id="fungsional3kirim" onclick='fungsionaltiga();'>Search</button>
                                  </div>
                              </ul>
                          </li>
                      </ul>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub"> 
                          <li class="sub-menu">
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <input type="text"  class="form-text" placeholder="input name" id="fungsi4nama" required>
                                                      <span class="bar"></span> 
                                                  </div>         
                                              </div> 
                                          </div>
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi4jenis">
                                      <option value="">-Choose-</option>
                                      <?php
                                          include("connect.php"); 
                                          $jenisumkm=mysqli_query($conn,"select * from umkm_type order by name DESC");
                                  ...
                                  <div class=" form-group">
                                      <li>
                                          <div class="search">
                                              <div class="col-md-12 padding-0 text-center">
                                                  <div class="form-group form-animate-text"><br>
                                                      <select class="form-control select2" style="width: 100%; height: 70%;" id="fungsi4angkot">
                                                      <option value="">-Choose-</option>
                                                      <?php
                                                      include("connect.php"); 
                                                      $angkotculinary=mysqli_query($conn,"select * from angkot order by id_angkot ASC");
                              ...
                              <ul class="treeview-menu">
                                  <div class=" form-group" style="color: white;"> <br>
                                      <label for="fungsi4radius">Radius :</label>
                                      <label  id="fungsi4nilai">0</label> x 100m
                                      <input  type="range" id="fungsi4radius" onchange="cekfungsi4();aktifkanfungsi4();"
                                              name="fungsi4radius" data-highlight="true" min="0" max="20" value="0" >
                                      <script>
                                          function cekfungsi4()
                                          {
                                              document.getElementById('fungsi4nilai').innerHTML=document.getElementById('fungsi4radius').value
                                          }
                                      </script>
                                  </div>
                              </ul>
                              <ul class="treeview-menu">
                                  <div class=" form-group">
                                      <button type="submit" class="btn btn-info btn-block btn-flat" id="fungsional4kirim" onclick='fungsionalempat();'>Search</button>
                                  </div>
                              </ul>
                          </li>
                      </ul>
